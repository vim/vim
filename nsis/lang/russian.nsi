...
LangString str_msg_registering   ${LANG_RUSSIAN} \
    "Регистрация программных компонентов в системе..."

LangString str_msg_unregistering ${LANG_RUSSIAN} \
    "Отмена регистрации программных компонентов в системе..."
...
LangString str_vimrc_page_subtitle ${LANG_RUSSIAN} \
    "Укажите параметры, используемые для клавиатуры, «мыши» и улучшения функциональности программы"
...
LangString str_msg_compat_vi       ${LANG_RUSSIAN} \
    "Вариант работы для совместимости с редактором Vim"
LangString str_msg_compat_vim      ${LANG_RUSSIAN} \
    "Вариант работы для полной функциональности редактора Vim"
LangString str_msg_compat_defaults ${LANG_RUSSIAN} \
    "Функциональность редактора Vim с некоторыми улучшениями (подключение файла defaults.vim)"
LangString str_msg_compat_all      ${LANG_RUSSIAN} \
    "Функциональность редактора Vim со всеми улучшениями (подключение файла vimrc_example.vim). \
    Этот вариант работы используется по умолчанию"

LangString str_msg_keymap_title   ${LANG_RUSSIAN} \
    " Клавиатурные команды "
LangString str_msg_keymap_desc    ${LANG_RUSSIAN} \
    "Изменить некоторые клавиатурные команды на используемые в ОС Windows (CTRL+V, CTRL+C, CTRL+S, CTRL+F и т. п.)"
LangString str_msg_keymap_default ${LANG_RUSSIAN} \
    "Не изменять клавиатурные команды. Будут использовать принятые по умолчанию в редакторе Vim"
...
LangString str_msg_mouse_desc    ${LANG_RUSSIAN} \
    "Настройка действий правой и левой кнопки манипулятора «мышь»"
LangString str_msg_mouse_default ${LANG_RUSSIAN} \
    "При нажатии правой кнопки — всплывающее меню, левой кнопки — переключение в режим визуальный"
LangString str_msg_mouse_windows ${LANG_RUSSIAN} \
    "При нажатии правой кнопки — всплывающее меню, левой кнопки — переключение в режим выбора (как в ОС Windows)"
LangString str_msg_mouse_unix    ${LANG_RUSSIAN} \
    "При нажатии правой кнопки — в расширенный режим выбора, левая кнопка — в режим визуальный (как в UNIX‐подобных ОС)"
