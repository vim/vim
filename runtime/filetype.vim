...
if exists("*fnameescape")
  ...
  au BufNewFile,BufRead *~ {
    ...
    var short = substitute(name, '\~\+$', '', '')
    if name != short && short != ""
      exe "doau filetypedetect BufRead " .. fnameescape(short)
    endif
  }
...
if !exists("g:ft_ignore_pat")
  g:ft_ignore_pat = '\.\(Z\|gz\|bz2\|zip\|tgz\)$'
endif
...
def StarSetf(filetype: string): void
...
# Abaqus or Trasys
au BufNewFile,BufRead *.inp			ft.Check_inp()
...
au BufNewFile,BufRead *.bas			ft.FTbas()
au BufNewFile,BufRead *.bi,*.bm			ft.FTbas()
...
# Batch file for MSDOS. See diff.FTsys for *.sys
...
au BufNewFile,BufRead *.sys\c			ft.FTsys()

# Batch file for 4DOS
au BufNewFile,BufRead *.btm			ft.FTbtm()
...
au BufNewFile,BufRead *.db			ft.BindzoneCheck('')
...
# C or lpc
au BufNewFile,BufRead *.c			ft.FTlpc()
...
au BufNewFile,BufRead *.cc {
  if exists("g:cynlib_syntax_for_cc")
    setf cynlib
  else
    setf cpp
  endif
...
au BufNewFile,BufRead *.cpp {
  if exists("g:cynlib_syntax_for_cpp")
    setf cynlib
  else
    setf cpp
  endif
...
au BufNewFile,BufRead *.h			ft.FTheader()
...
au BufNewFile,BufRead *.ch			ft.FTchange()
...
# Clever or dtd
au BufNewFile,BufRead *.ent			ft.FTent()

# Clipper, FoxPro, ABB RAPID or eviews
au BufNewFile,BufRead *.prg\c			ft.FTprg()
...
# Elixir or Euphoria
au BufNewFile,BufRead *.ex ft.ExCheck()
...
# Euphoria 3 or 4
au BufNewFile,BufRead *.eu,*.ew,*.exu,*.exw	     ft.EuphoriaCheck()
if has("fname_case")
   au BufNewFile,BufRead *.EU,*.EW,*.EX,*.EXU,*.EXW  ft.EuphoriaCheck()
endif
...
# Configure files
au BufNewFile,BufRead *.cfg\c			ft.FTcfg()
...
au BufNewFile,BufRead *.d			ft.DtraceCheck()
...
au BufNewFile,BufRead */debian/patches/*	ft.Dep3patch()
...
au BufNewFile,BufRead *.com			ft.BindzoneCheck('dcl')
...
au BufNewFile,BufRead *.e,*.E			ft.FTe()
...
# Fortran or Forth
au BufNewFile,BufRead *.f			ft.FTf()
...
# F# or Forth
au BufNewFile,BufRead *.fs			ft.FTfs()
...
au BufNewFile,BufRead *.html,*.htm,*.shtml,*.stm  ft.FThtml()
...
au BufNewFile,BufRead *.idl			ft.FTidl()
...
au BufNewFile,BufRead indent.pro		ft.ProtoCheck('indent')

# IDL (Interactive Data Language)
au BufNewFile,BufRead *.pro			ft.ProtoCheck('idlang')
...
# Kuka Robot Language
au BufNewFile,BufRead *.src\c			ft.FTsrc()
au BufNewFile,BufRead *.dat\c			ft.FTdat()
...
au BufNewFile,BufRead .lsl			ft.FTlsl()
...
# LambdaProlog or SML (see foobar.FTmod for *.mod)
au BufNewFile,BufRead *.sig			ft.FTsig()
...
au BufNewFile,BufRead *.m4 {
  if expand("<afile>") !~? 'html.m4$\|fvwm2rc'
    setf m4
  endif
}
...
au BufNewFile,BufRead *.m			ft.FTm()
...
au BufNewFile,BufRead *.mpxl,*.mpiv,*.mpvi {
  b:mp_metafun = 1
  setf mp
}
...
au BufNewFile,BufRead *.mms			ft.FTmms()

# Symbian meta-makefile definition (MMP)
au BufNewFile,BufRead *.mmp			setf mmp

# ABB Rapid, Modula-2, Modsim III or LambdaProlog
au BufNewFile,BufRead *.mod\c			ft.FTmod()

# Modula-2  (.md removed in favor of Markdown, see foobar.FTmod for *.MOD)
...
au BufNewFile,BufRead *.[1-9]			     ft.FTnroff()

# Nroff or Objective C++
au BufNewFile,BufRead *.mm			ft.FTmm()
...
# OpenFOAM
au BufNewFile,BufRead [a-zA-Z0-9]*Dict\(.*\)\=,[a-zA-Z]*Properties\(.*\)\=,*Transport\(.*\),fvSchemes,fvSolution,fvConstrains,fvModels,*/constant/g,*/0\(\.orig\)\=/*  ft.FTfoam()
...
au BufNewFile,BufRead *.pp			ft.FTpp()
...
# Perl
if has("fname_case")
  au BufNewFile,BufRead *.pl,*.PL		ft.FTpl()
else
  au BufNewFile,BufRead *.pl			ft.FTpl()
endif
...
au BufNewFile,BufRead *.inc			ft.FTinc()
...
# Progress or CWEB
au BufNewFile,BufRead *.w			ft.FTprogress_cweb()

# Progress or assembly
au BufNewFile,BufRead *.i			ft.FTprogress_asm()

# Progress or Pascal
au BufNewFile,BufRead *.p			ft.FTprogress_pascal()
...
au BufNewFile,BufRead *.reg {
  if getline(1) =~? '^REGEDIT[0-9]*\s*$\|^Windows Registry Editor Version \d*\.\d*\s*$'
    setf registry
  endif
}
...
# Rexx, Rebol or R
au BufNewFile,BufRead *.r,*.R			ft.FTr()
...
# SuperCollider
au BufNewFile,BufRead *.sc			ft.FTsc()

au BufNewFile,BufRead *.quark			setf supercollider

# scdoc
au BufNewFile,BufRead *.scd			ft.FTscd()
...
# Maxima.
au BufNewFile,BufRead *.mc			ft.McSetf()
...
au BufNewFile,BufRead .bashrc,bashrc,bash.bashrc,.bash[_-]profile,.bash[_-]logout,.bash[_-]aliases,bash-fc[-.],*.ebuild,*.bash,*.eclass,PKGBUILD,APKBUILD ft.SetFileTypeSH("bash")
au BufNewFile,BufRead .kshrc,*.ksh ft.SetFileTypeSH("ksh")
au BufNewFile,BufRead */etc/profile,.profile,*.sh,*.env ft.SetFileTypeSH(getline(1))
...
au BufNewFile,BufRead *.install {
  if getline(1) =~ '<?php'
    ...
    ft.SetFileTypeSH("bash")
  endif
}

# tcsh scripts (patterns ending in a star further below)
au BufNewFile,BufRead .tcshrc,*.tcsh,tcsh.tcshrc,tcsh.login  ft.SetFileTypeShell("tcsh")

# csh scripts, but might also be tcsh scripts (on some systems csh is tcsh)
# (patterns ending in a start further below)
au BufNewFile,BufRead .login,.cshrc,csh.cshrc,csh.login,csh.logout,*.csh,.alias  ft.CSH()
...
au BufNewFile,BufRead *.cls			ft.FTcls()
...
au BufNewFile,BufRead *.rules			    ft.FTRules()
...
au BufNewFile,BufRead *.typ			ft.FTtyp()

# SQL
au BufNewFile,BufRead *.sql			ft.SQL()
...
au BufNewFile,BufRead *.sil			ft.FTsil()
...
au BufNewFile,BufRead *.tex			       ft.FTtex()
...
au BufNewFile,BufRead *.tf			ft.FTtf()
...
au BufNewFile,BufRead *.v			ft.FTv()
...
au BufNewFile,BufRead *.frm			ft.FTfrm()
...
au BufNewFile,BufRead *.vba			ft.FTvba()
...
# Xorg config
au BufNewFile,BufRead xorg.conf,xorg.conf-4 {
  b:xf86conf_xfree86_version = 4
  setf xf86conf
}
...
au BufNewFile,BufRead *.xml			ft.FTxml()
...
# Yacc or racc
au BufNewFile,BufRead *.y			ft.FTy()
...
au BufNewFile,BufRead *.dtml,*.pt,*.cpt		ft.FThtml()
#   zsql (zope sql method)
au BufNewFile,BufRead *.zsql			ft.SQL()
...
# Vim 5.x.
if exists("g:myfiletypefile") && filereadable(expand(myfiletypefile))
...
# script file.
# Most of these should call StarSetf() to avoid names ending in .gz and the
# like are used.

# More Apache style config files
au BufNewFile,BufRead */etc/proftpd/*.conf*,*/etc/proftpd/conf.*/*	StarSetf('apachestyle')
au BufNewFile,BufRead proftpd.conf*					StarSetf('apachestyle')

# More Apache config files
au BufNewFile,BufRead access.conf*,apache.conf*,apache2.conf*,httpd.conf*,srm.conf*	StarSetf('apache')
au BufNewFile,BufRead */etc/apache2/*.conf*,*/etc/apache2/conf.*/*,*/etc/apache2/mods-*/*,*/etc/apache2/sites-*/*,*/etc/httpd/conf.*/*,*/etc/httpd/mods-*/*,*/etc/httpd/sites-*/*,*/etc/httpd/conf.d/*.conf*	StarSetf('apache')

# APT config file
au BufNewFile,BufRead */etc/apt/apt.conf.d/{[-_[:alnum:]]\+,[-_.[:alnum:]]\+.conf}  StarSetf('aptconf')

# Asterisk config file
au BufNewFile,BufRead *asterisk/*.conf*		   StarSetf('asterisk')
au BufNewFile,BufRead *asterisk*/*voicemail.conf*  StarSetf('asteriskvm')
...
# BIND zone
au BufNewFile,BufRead */named/db.*,*/bind/db.*	StarSetf('bindzone')

au BufNewFile,BufRead cabal.project.*		StarSetf('cabalproject')
...
# Crontab
au BufNewFile,BufRead crontab,crontab.*,*/etc/cron.d/*	StarSetf('crontab')

# dnsmasq(8) configuration
au BufNewFile,BufRead */etc/dnsmasq.d/*		StarSetf('dnsmasq')

# Dockerfile
au BufNewFile,BufRead Dockerfile.*,Containerfile.*  StarSetf('dockerfile')

# Dracula
au BufNewFile,BufRead drac.*			StarSetf('dracula')

# Fvwm
au BufNewFile,BufRead */.fvwm/*			StarSetf('fvwm')
...
# Gedcom
au BufNewFile,BufRead */tmp/lltmp*		StarSetf('gedcom')

# Git
au BufNewFile,BufRead */.gitconfig.d/*,*/etc/gitconfig.d/*  StarSetf('gitconfig')

# Gitolite
au BufNewFile,BufRead */gitolite-admin/conf/*	StarSetf('gitolite')

# GTK RC
au BufNewFile,BufRead .gtkrc*,gtkrc*		StarSetf('gtkrc')

# Jam
au BufNewFile,BufRead Prl*.*,JAM*.*		StarSetf('jam')
...
# Java Properties resource file (note: doesn't catch font.properties.pl)
au BufNewFile,BufRead *.properties_??_??_*	StarSetf('jproperties')

# Kconfig
au BufNewFile,BufRead Kconfig.*			StarSetf('kconfig')

# Lilo: Linux loader
au BufNewFile,BufRead lilo.conf*		StarSetf('lilo')

# Libsensors
au BufNewFile,BufRead */etc/sensors.d/[^.]*	StarSetf('sensors')

# Logcheck
au BufNewFile,BufRead */etc/logcheck/*.d*/*	StarSetf('logcheck')

# Makefile
au BufNewFile,BufRead [mM]akefile*		StarSetf('make')

# Ruby Makefile
au BufNewFile,BufRead [rR]akefile*		StarSetf('ruby')

# Mail (also matches muttrc.vim, so this is below the other checks)
au BufNewFile,BufRead {neo,}mutt[[:alnum:]._-]\\\{6\}	setf mail

au BufNewFile,BufRead reportbug-*		StarSetf('mail')
...
au BufNewFile,BufRead */etc/modprobe.*		StarSetf('modconf')

# Mutt setup files (must be before catch *.rc)
au BufNewFile,BufRead */etc/Muttrc.d/*		StarSetf('muttrc')

# Mutt setup file
au BufNewFile,BufRead .mutt{ng,}rc*,*/.mutt{ng,}/mutt{ng,}rc*	StarSetf('muttrc')
au BufNewFile,BufRead mutt{ng,}rc*,Mutt{ng,}rc*			StarSetf('muttrc')

# Neomutt setup file
au BufNewFile,BufRead .neomuttrc*,*/.neomutt/neomuttrc*	 StarSetf('neomuttrc')
au BufNewFile,BufRead neomuttrc*,Neomuttrc*		 StarSetf('neomuttrc')

# Nroff macros
au BufNewFile,BufRead tmac.*			StarSetf('nroff')

# OpenBSD hostname.if
au BufNewFile,BufRead */etc/hostname.*		StarSetf('config')

# Pam conf
au BufNewFile,BufRead */etc/pam.d/*		StarSetf('pamconf')
...
au BufRead,BufNewFile *.rdf			ft.Redif()

# Remind
au BufNewFile,BufRead .reminders*		StarSetf('remind')

# SGML catalog file
au BufNewFile,BufRead sgml.catalog*		StarSetf('catalog')

# avoid doc files being recognized a shell files
au BufNewFile,BufRead */doc/{,.}bash[_-]completion{,.d,.sh}{,/*} setf text

# Shell scripts ending in a star
au BufNewFile,BufRead .bashrc*,.bash[_-]profile*,.bash[_-]logout*,.bash[_-]aliases*,bash-fc[-.]*,PKGBUILD*,APKBUILD*,*/{,.}bash[_-]completion{,.d,.sh}{,/*}  ft.SetFileTypeSH("bash")
au BufNewFile,BufRead .kshrc*			ft.SetFileTypeSH("ksh")
au BufNewFile,BufRead .profile*			ft.SetFileTypeSH(getline(1))

# Sudoers
au BufNewFile,BufRead */etc/sudoers.d/*		StarSetf('sudoers')

# tcsh scripts ending in a star
au BufNewFile,BufRead .tcshrc*			ft.SetFileTypeShell("tcsh")

# csh scripts ending in a star
au BufNewFile,BufRead .login*,.cshrc*		ft.CSH()
...
# VHDL
au BufNewFile,BufRead *.vhdl_[0-9]*		StarSetf('vhdl')

# Vim script
au BufNewFile,BufRead *vimrc*			StarSetf('vim')

# Subversion commit file
au BufNewFile,BufRead svn-commit*.tmp		setf svn

# X resources file
au BufNewFile,BufRead Xresources*,*/app-defaults/*,*/Xresources/*  StarSetf('xdefaults')
...
# X11 xmodmap
au BufNewFile,BufRead *xmodmap*			StarSetf('xmodmap')

# Xinetd conf
au BufNewFile,BufRead */etc/xinetd.d/*		StarSetf('xinetd')

# yum conf (close enough to dosini)
au BufNewFile,BufRead */etc/yum.repos.d/*	StarSetf('dosini')

# Z-Shell script ending in a star
au BufNewFile,BufRead .zsh*,.zlog*,.zcompdump*	StarSetf('zsh')
au BufNewFile,BufRead zsh*,zlog*		StarSetf('zsh')
...
if has("menu") && has("gui_running")
    && !exists("g:did_install_syntax_menu") && &guioptions !~# "M"
...
def TestFiletypeFuncs(testlist: list<string>): string
  var output = ''
  for f in testlist
    try
      exe f
