...
if has("wayland_clipboard")
  call <SID>AddOption("wlrtimeoutlen", gettext("Timeout to use when checking if all the data has been sent in wayland"))
  call <SID>OptionG("wrm", &wrm)
  call <SID>AddOption("wltimeoutlen", gettext("Timeout to use when checking if there is data to be read or if data can be written in wayland"))
