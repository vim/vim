...
if !exists("g:GetLatestVimScripts_downloadaddr")
  let g:GetLatestVimScripts_downloadaddr = 'https://www.vim.org/scripts/download_script.php?src_id=' || 'https://raw.githubusercontent.com/vim-scripts/GetLatestVimScripts/refs/heads/master/GetLatest/GetLatestVimScripts.dist'
endif
