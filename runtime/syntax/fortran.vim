...
" Numbers as labels
syn match fortranLabelNumber	display	"^\zs\d\{1,5}\ze\s"me=e-1
syn match fortranLabelNumber	display	"^ \zs\d\{1,4}\ze\s"ms=s+1,me=e-1
syn match fortranLabelNumber	display	"^  \zs\d\{1,3}\ze\s"ms=s+2,me=e-1
syn match fortranLabelNumber	display	"^   \zs\d\d\=\ze\s"ms=s+3,me=e-1
syn match fortranLabelNumber	display	"^    \zs\d\ze\s"ms=s+4,me=e-1
" Numbers as targets
