...
syn keyword abapStatement SCAN SCROLL SEARCH SELECT SET SHIFT SKIP SORT SORTED SPLIT STANDARD STATISTICS STEP STOP SUBMIT SUBTRACT SUM SUMMARY SUPPRESS
