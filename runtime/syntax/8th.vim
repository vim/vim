...
Builtin  requires G:requires reset G:reset roll G:roll rop! G:rop! rot G:rot rpick G:rpick rreset G:rreset
...
Builtin  sleep G:sleep sleep-msec G:sleep-msec sleep-until G:sleep-until slog G:slog space G:space stack-check G:stack-check
...
Builtin  third G:third throw G:throw thrownull G:thrownull times G:times tlog G:tlog toggle G:toggle
Builtin  tri G:tri true G:true tuck G:tuck type-check G:type-check typeassert G:typeassert uid G:uid
Builtin  uname G:uname unlock G:unlock unpack G:unpack until G:until until! G:until! while G:while while! G:while!
Builtin  with: G:with: word? G:word? words G:words words-like G:words-like words/ G:words/ xchg G:xchg
Builtin  xor G:xor >auth HTTP:>auth (curry) I:(curry) notimpl I:notimpl sh I:sh trace-word I:trace-word
...
Builtin  REMOTE_IP net:REMOTE_IP REMOTE_IP net:REMOTE_IP STREAM net:STREAM accept net:accept active? net:active?
Builtin  addrinfo>o net:addrinfo>o again? net:again? alloc-and-read net:alloc-and-read alloc-buf net:alloc-buf
Builtin  base64url> net:base64url> bind net:bind cgi-get net:cgi-get cgi-http-header net:cgi-http-header
Builtin  cgi-init net:cgi-init cgi-init-stunnel net:cgi-init-stunnel cgi-out net:cgi-out close net:close
Builtin  closed? net:closed? connect net:connect curnet net:curnet debug? net:debug? delete net:delete
Builtin  dns net:dns get net:get getaddrinfo net:getaddrinfo getpeername net:getpeername head net:head
Builtin  ifaces? net:ifaces? ipv6? net:ipv6? listen net:listen map>url net:map>url mime-type net:mime-type
...
Builtin  button-symbol-label nk:button-symbol-label center-rect nk:center-rect chart-add-slot nk:chart-add-slot
...
Builtin  close? nk:close? color-picker nk:color-picker combo nk:combo combo-begin-color nk:combo-begin-color
Builtin  combo-begin-label nk:combo-begin-label combo-cb nk:combo-cb combo-end nk:combo-end contextual-begin nk:contextual-begin
...
Builtin  cursor-show nk:cursor-show display-info nk:display-info display@ nk:display@ do nk:do down? nk:down?
Builtin  draw-image nk:draw-image draw-image-at nk:draw-image-at draw-image-centered nk:draw-image-centered
...
Builtin  plot nk:plot plot-fn nk:plot-fn polygon nk:polygon pop-font nk:pop-font popup-begin nk:popup-begin
...
Builtin  render-timed nk:render-timed rendering nk:rendering restore nk:restore rotate nk:rotate rotate-rel nk:rotate-rel
Builtin  save nk:save scale nk:scale scancode? nk:scancode? screen-saver nk:screen-saver screen-size nk:screen-size
...
Builtin  +/ r:+/ +match r:+match / r:/ @ r:@ len r:len match r:match new r:new rx r:rx str r:str * rat:*
Builtin  + rat:+ - rat:- / rat:/ >n rat:>n >s rat:>s new rat:new proper rat:proper ! s:! * s:* + s:+
Builtin  - s:- / s:/ /scripts s:/scripts <+ s:<+ <> s:<> = s:= =ic s:=ic >base64 s:>base64 >ucs2 s:>ucs2
Builtin  @ s:@ append s:append base64> s:base64> clear s:clear cmp s:cmp cmpi s:cmpi compress s:compress
Builtin  count-match s:count-match days! s:days! dist s:dist each s:each each! s:each! eachline s:eachline
Builtin  escape s:escape expand s:expand fill s:fill fold s:fold gen-uid s:gen-uid globmatch s:globmatch
Builtin  hexupr s:hexupr insert s:insert intl s:intl intl! s:intl! lang s:lang lc s:lc lc? s:lc? len s:len
Builtin  lsub s:lsub ltrim s:ltrim map s:map months! s:months! n> s:n> new s:new norm s:norm reduce s:reduce
Builtin  repinsert s:repinsert replace s:replace replace! s:replace! rev s:rev rsearch s:rsearch rsub s:rsub
Builtin  rtrim s:rtrim scan-match s:scan-match script? s:script? search s:search size s:size slice s:slice
Builtin  soundex s:soundex strfmap s:strfmap strfmt s:strfmt term s:term text-wrap s:text-wrap tr s:tr
Builtin  translate s:translate trim s:trim tsub s:tsub uc s:uc uc? s:uc? ucs2> s:ucs2> utf8? s:utf8?
Builtin  zt s:zt close sio:close enum sio:enum open sio:open opts! sio:opts! opts@ sio:opts@ read sio:read
Builtin  write sio:write @ slv:@ auto slv:auto build slv:build constraint slv:constraint dump slv:dump
Builtin  edit slv:edit named-variable slv:named-variable new slv:new relation slv:relation reset slv:reset
Builtin  suggest slv:suggest term slv:term update slv:update v[] slv:v[] variable slv:variable v{} slv:v{}
Builtin  new smtp:new send smtp:send apply-filter snd:apply-filter devices? snd:devices? end-record snd:end-record
...
Builtin  volume snd:volume volume? snd:volume? + st:+ . st:. clear st:clear dot-depth st:dot-depth len st:len
Builtin  list st:list ndrop st:ndrop new st:new op! st:op! peek st:peek pick st:pick pop st:pop push st:push
