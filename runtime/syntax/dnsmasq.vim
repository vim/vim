...
syn match DnsmasqKeyword    "^\s*add-cpe-id\>"
...
syn match DnsmasqKeyword    "^\s*auth-peer\>"
syn match DnsmasqKeyword    "^\s*auth-sec-servers\>"
syn match DnsmasqKeyword    "^\s*auth-server\>"
syn match DnsmasqKeyword    "^\s*auth-soa\>"
syn match DnsmasqKeyword    "^\s*auth-ttl\>"
...
syn match DnsmasqKeyword    "^\s*caa-record\>"
syn match DnsmasqKeyword    "^\s*cache-rr\>"
...
syn match DnsmasqKeyword    "^\s*conf-script\>"
syn match DnsmasqKeyword    "^\s*connmark-allowlist-enable\>"
syn match DnsmasqKeyword    "^\s*connmark-allowlist\>"
...
syn match DnsmasqKeyword    "^\s*dhcp-ignore-clid\>"
...
syn match DnsmasqKeyword    "^\s*dhcp-split-relay\>"
syn match DnsmasqKeyword    "^\s*dhcp-subscrid\>"
syn match DnsmasqKeyword    "^\s*dhcp-ttl\>"
syn match DnsmasqKeyword    "^\s*dhcp-userclass\>"
syn match DnsmasqKeyword    "^\s*dhcp-vendorclass\>"
syn match DnsmasqKeyword    "^\s*dns-forward-max\>"
syn match DnsmasqKeyword    "^\s*dns-loop-detect\>"
syn match DnsmasqKeyword    "^\s*dns-rr\>"
syn match DnsmasqKeyword    "^\s*dnssec-check-unsigned\>"
syn match DnsmasqKeyword    "^\s*dnssec-debug\>"
syn match DnsmasqKeyword    "^\s*dnssec-limits\>"
...
syn match DnsmasqKeyword    "^\s*do-0x20-encode\>"
syn match DnsmasqKeyword    "^\s*do-x20-encode\>"
syn match DnsmasqKeyword    "^\s*domain-needed\>"
syn match DnsmasqKeyword    "^\s*domain\>"
syn match DnsmasqKeyword    "^\s*dumpfile\>"
syn match DnsmasqKeyword    "^\s*dumpmask\>"
syn match DnsmasqKeyword    "^\s*dynamic-host\>"
...
syn match DnsmasqKeyword    "^\s*enable-ubus\>"
syn match DnsmasqKeyword    "^\s*except-interface\>"
syn match DnsmasqKeyword    "^\s*expand-hosts\>"
syn match DnsmasqKeyword    "^\s*fast-dns-retry\>"
syn match DnsmasqKeyword    "^\s*filter-AAAA\>"
syn match DnsmasqKeyword    "^\s*filter-A\>"
syn match DnsmasqKeyword    "^\s*filter-rr\>"
syn match DnsmasqKeyword    "^\s*filterwin2k\>"
syn match DnsmasqKeyword    "^\s*group\>"
syn match DnsmasqKeyword    "^\s*help\>"
syn match DnsmasqKeyword    "^\s*host-record\>"
syn match DnsmasqKeyword    "^\s*hostsdir\>"
...
syn match DnsmasqKeyword    "^\s*leasequery\>"
...
syn match DnsmasqKeyword    "^\s*log-debug\>"
syn match DnsmasqKeyword    "^\s*log-dhcp\>"
syn match DnsmasqKeyword    "^\s*log-facility\>"
syn match DnsmasqKeyword    "^\s*log-malloc\>"
syn match DnsmasqKeyword    "^\s*log-queries\>"
syn match DnsmasqKeyword    "^\s*max-cache-ttl\>"
syn match DnsmasqKeyword    "^\s*max-port\>"
syn match DnsmasqKeyword    "^\s*max-tcp-connections\>"
...
syn match DnsmasqKeyword    "^\s*nftset\>"
syn match DnsmasqKeyword    "^\s*no-0x20-encode\>"
syn match DnsmasqKeyword    "^\s*no-daemon\>"
syn match DnsmasqKeyword    "^\s*no-dhcp-interface\>"
syn match DnsmasqKeyword    "^\s*no-dhcpv4-interface\>"
syn match DnsmasqKeyword    "^\s*no-dhcpv6-interface\>"
syn match DnsmasqKeyword    "^\s*no-hosts\>"
syn match DnsmasqKeyword    "^\s*no-ident\>"
...
syn match DnsmasqKeyword    "^\s*no-round-robin\>"
syn match DnsmasqKeyword    "^\s*pid-file\>"
syn match DnsmasqKeyword    "^\s*port-limit\>"
...
syn match DnsmasqKeyword    "^\s*quiet-tftp\>"
...
syn match DnsmasqKeyword    "^\s*tftp-mtu\>"
...
syn match DnsmasqKeyword    "^\s*tftp-single-port\>"
syn match DnsmasqKeyword    "^\s*tftp-unique-root\>"
syn match DnsmasqKeyword    "^\s*trust-anchor\>"
syn match DnsmasqKeyword    "^\s*txt-record\>"
syn match DnsmasqKeyword    "^\s*umbrella\>"
syn match DnsmasqKeyword    "^\s*use-stale-cache\>"
