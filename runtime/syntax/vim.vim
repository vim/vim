...
syn keyword vimHLGroup contained User1 User2 User3 User4 User5 User6 User7 User8 User9
" :terminal group
syn keyword vimHLGroup contained Terminal
syn case match
