...
syn region	vimGroupList	contained
      ...
      \ end="\s"he=e-1
      \ end="$"
      \ contains=@vimGroupListContinue,vimGroupSpecial,vimGroupListContinueComma,vimGroupListContinueStart
syn keyword	vimGroupSpecial	contained	ALL	ALLBUT	CONTAINED	TOP
syn match	vimGroupListComma		contained	","
syn match	vimGroupListContinueComma	contained	"\s\+,"	contains=vimGroupListComma
syn match	vimGroupListContinueComma	contained	",\s\+"	contains=vimGroupListComma
syn match	vimGroupListContinueComma	contained	"\s\+,\s\+"	contains=vimGroupListComma
...
syn match	vimGroupListContinueStart	contained	"=\s*\%(\%(\n\s*["#]\\ .*\)*\n\s*\\\s\+\)\="	contains=@vimGroupListContinue,vimGroupListEquals transparent
...
if !exists("g:vimsyn_noerror") && !exists("g:vimsyn_novimsynerror")
 ...
 syn match	vimSynError		contained	"\i\+"	skipwhite nextgroup=vimGroupList
endif
syn match	vimSynContains		contained	"\<contains\>"	skipwhite nextgroup=vimGroupList
syn match	vimSynContainedin		contained	"\<containedin\>"	skipwhite nextgroup=vimGroupList
syn match	vimSynNextgroup		contained	"\<nextgroup\>"	skipwhite nextgroup=vimGroupList
if has("conceal")
...
syn match	vimGroupAdd	contained keepend	"\<add\>"	skipwhite nextgroup=vimGroupList
syn match	vimGroupRem	contained keepend	"\<remove\>"	skipwhite nextgroup=vimGroupList
...
" Syntax: include {{{2
syn keyword	vimSynType	contained	include
