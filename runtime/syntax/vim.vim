...
syn region	vim9LambdaReturnType  contained	start=":\s" end="$" end="\ze\s*#" end="\ze\s*=>" skipwhite skipempty nextgroup=vim9LambdaOperator,vim9LamdaOperatorComment contains=vimTypeSep transparent
