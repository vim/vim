...
VimFoldl syn region vimLuaRegion	contained
...
VimFoldm syn region vimMzSchemeRegion	contained
      \ matchgroup=vimScriptHereDocStart
      \ start=+<<\s*\z(\S\+\)\ze\s*$+
      \ matchgroup=vimScriptHereDocStop
      \ end=+^\z1$+
...
VimFoldp syn region vimPerlRegion	contained
       \ matchgroup=vimScriptHereDocStart
       \ start=+<<\s*\z(\S\+\)\ze\s*$+
       \ matchgroup=vimScriptHereDocStop
...
VimFoldP syn region vimPythonRegion		contained
      \ matchgroup=vimScriptHereDocStart
      \ start=+<<\s*\z(\S\+\)\ze\s*$+
      \ matchgroup=vimScriptHereDocStop
      \ end=+^\z1$+
...
VimFoldr syn region vimRubyRegion	contained
      \ matchgroup=vimScriptHereDocStart
      \ start=+<<\s*\z(\S\+\)\ze\s*$+
      \ matchgroup=vimScriptHereDocStop
      \ end=+^\z1$+
...
VimFoldt syn region vimTclRegion	contained
      \ matchgroup=vimScriptHereDocStart
      \ start=+<<\s*\z(\S\+\)\ze\s*$+
      \ matchgroup=vimScriptHereDocStop
      \ end=+^\z1$+
