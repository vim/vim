...
if s:vim9script
  ...
  " Enums {{{3
  syn cluster	vim9EnumBodyList		contains=vim9Abstract,vim9Enum,vim9Comment,vim9LineComment,@vim9Continue,@vimExprList,@vim9MethodDef,vim9Public,vim9Static,vim9Const,vim9Final,vim9This,vim9Var

  syn match	vim9Enum		contained	"\<enum\>"	skipwhite	  nextgroup=vim9EnumName
  syn match	vim9EnumName		contained	"\<\u\w*\>"	skipwhite skipempty nextgroup=vim9EnumImplements,vim9EnumValue,vim9EnumValueListComment
  syn keyword	vim9EnumImplements	contained	implements	skipwhite skipempty nextgroup=vim9EnumImplementedInterface
  syn match	vim9EnumImplementedInterface	contained	"\<\u\w*\>"	skipwhite skipempty nextgroup=vim9EnumInterfaceListComma,vim9EnumValueListComment,vim9EnumValue
  syn match	vim9EnumInterfaceListComma	contained	","	skipwhite skipempty nextgroup=vim9EnumImplementedInterface
  ...
  syn match	vim9EnumValueListComma	contained	","	skipwhite skipempty nextgroup=vim9EnumValue,vim9EnumValueListComment
  syn match	vim9EnumValueListComment	contained	"#.*"	skipwhite skipempty nextgroup=vim9EnumValueListComment,vim9EnumValue
  syn region	vim9EnumValueArgList	contained	matchgroup=vimParenSep start="(" end=")" nextgroup=vim9EnumValueListComma contains=@vimExprList,vim9Comment
...
if !exists("skip_vim_syntax_inits")
 ...
 hi def link vim9EnumValueListComment	vim9Comment
