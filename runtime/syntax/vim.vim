...
syn match	vimRangeOffset    contained	"[+-]\%(\d\+\)\=\|\d\+"                        skipwhite nextgroup=vimRangeOffset,vimRangeSeparator,vimCmdStart,@vimCmdList,@vimCommand_
...
syn region	vimAutocmdPattern	contained
      ...
      \ end="\ze[,[:space:]]"
      \ end="$"
      \ skipwhite skipnl nextgroup=vimAutocmdPatternSep,vimAutocmdMod,vimAutocmdBlock,@vimFunc,vimCmdStart,@vimRange,@vimCmdList,@vimAutocmdContinue
      \ contains=vimEnvvar,@vimWildcard,vimAutocmdPatternEscape
syn match	vimAutocmdBufferPattern	contained	"<buffer\%(=\%(\d\+\|abuf\)\)\=>" skipwhite skipnl nextgroup=vimAutocmdPatternSep,vimAutocmdMod,vimAutocmdBlock,@vimFunc,vimCmdStart,@vimRange,@vimCmdList,@vimAutocmdContinue
...
syn match	vimAutocmdPatternSep	contained	",\ze\s\+"	                skipwhite skipnl nextgroup=vimAutocmdMod,vimAutocmdBlock,vimCmdStart,@vimRange,@vimCmdList,@vimAutocmdContinue
...
syn match	vimAutocmdMod	contained	"\%(++\)\=\<nested\>" skipwhite skipnl nextgroup=vimAutocmdMod,vimAutocmdBlock,vimCmdStart,@vimRange,@vimCmdList,@vimAutocmdContinue
syn match	vimAutocmdMod	contained	"++once\>"	    skipwhite skipnl nextgroup=vimAutocmdMod,vimAutocmdBlock,vimCmdStart,@vimRange,@vimCmdList,@vimAutocmdContinue
