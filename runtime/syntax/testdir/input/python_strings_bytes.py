...
test = f"List elements are {s[:2:]}"
test = f"Padded list copy is {s[:]:99}"
test = f"Left-aligned list slice is {s[1:]:<99}"
test = f"Right aligned list slice is {s[:9]:>99}"
test = f"Center-aligned list elements are {s[:2:]:^99}"
