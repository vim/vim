...
syn region  edAddress_Pattern  contained
      ...
      \ end=/?\|$/
      \ skipwhite nextgroup=@edAddressModifier,edAddressSeparator,@edCommand
      \ contains=edRegex_QuestionMarkEscape,edRegex_BracketExpression

syn match   edRegex_BracketExpression  contained
      \ "\[\^\=\]\=\%(\[:.\{-}:\]\|\[\..\{-}\.\]\|\[=.\{-}=\]\|[^]]\)*\]"
      \ transparent
syn match   edRegex_SlashEscape		contained +\\/+ transparent
syn match   edRegex_QuestionMarkEscape	contained +\\?+ transparent
...
" Global Command {{{2
" TODO: GNU ed extension allows suffixes
...
syn match   edCommand_iG  contained
      \ /G/
      \ nextgroup=edCommand_iG_Arg_Regexp
syn region  edCommand_iG_Arg_Regexp  contained
      \ matchgroup=Delimiter
      \ start=/\z([^\\[:space:]\n]\)/
      \ end=/\z1\|$/
syn match   edCommand_ampersand  contained
      \ /&/
...
syn match   edCommand_r  contained
      \ /r\>/
      \ skipwhite
      \ nextgroup=edArg_File,edCommand_exclamation
...
syn region  edCommand_s_Arg_Replacement  contained
      ...
      \ skip=/\\\z1\|\\$/
      \ end=/\z1\|$/
      \ nextgroup=edCommand_s_Arg_Flag,edCommand_s_Arg_Count,edCommand_s_Suffix
      \ contains=edCommand_s_Arg_Replacement_Escape,
      \		 edCommand_s_Arg_Replacement_Continue,
      \		 edCommand_s_Arg_Replacement_Match
...
syn region  edCommand_s_Arg_Replacement  contained
      ...
      \ end=/\%(\z1%\)\@<=\%(\z1\|$\)/
      \ nextgroup=edCommand_s_Arg_Flag,edCommand_s_Arg_Count,edCommand_s_Suffix
      \ contains=edCommand_s_Arg_Replacement_Repeat
      \ oneline

syn match   edCommand_s_Arg_Replacement_Escape	  contained /\\./
syn match   edCommand_s_Arg_Replacement_Continue  contained /\\$/
syn match   edCommand_s_Arg_Replacement_Match	  contained /&/
syn match   edCommand_s_Arg_Replacement_Repeat	  contained /%/

hi def link edCommand_s_Arg_Replacement_Escape Special
hi def link edCommand_s_Arg_Replacement_Continue Special
hi def link edCommand_s_Arg_Replacement_Match Special
hi def link edCommand_s_Arg_Replacement_Repeat Special
...
syn match   edCommand_s_Arg_Count  contained
      \ /\d\+/
      \ nextgroup=edCommand_s_Arg_Flag,edCommand_s_Suffix
hi def link edCommand_s_Arg_Count Special

syn match  edCommand_s_Suffix  contained
      \ /[lnp]/
      \ skipnl
      \ nextgroup=edCommand_s_Suffix,edCommand_s_Arg_Flag,edCommand_s_Arg_Count

" repeat last s command
" BSD/GNU extension

syn match   edCommand_s
      "\ /^\s*\zss\%(\([[:digit:]gpr]\).*\1\)\@![[:digit:]gpr]\{1,4}\ze\s*\\\=$/
      "\ /s\%(\%([gpr]\|\d\+\)\{1,4}\&\%(.*g.*g\)\@!\&\%(.*p.*p\)\@!\&\%(.*r.*r\)\@!\&\%(.*\d\+.*\d\+\)\@!.*\)\>/
      \ /s\%(\%([gpr]\|\d\+\)\{1,4}\&\%(.*\([gpr]\).*\1\)\@!\&\%(.*\d\+.*\d\+\)\@!.*\)\>/
      \ contains=edCommand_s_Arg_flag,edCommand_s_Arg_Count,edCommandSuffix
...
syn match   edCommand_iV  contained
      \ /V/
      \ nextgroup=edCommand_iV_Arg_Regexp
syn region  edCommand_iV_Arg_Regexp  contained
      \ matchgroup=Delimiter
      \ start=/\z([^\\[:space:]\n]\)/
      \ end=/\z1\|$/
...
" Edit Command {{{2
syn match   edCommand_e  contained
      \ /\<e\>/
      \ skipwhite
      \ nextgroup=edArg_File,edCommand_exclamation
...
syn match   edCommand_exclamation  contained
      \ /!/
      \ skipwhite
      \ nextgroup=edCommand_exclamation_Arg_Command,edCommand_exclamation_Arg_Previous
syn match   edCommand_exclamation_Arg_Command  contained
      \ /\S.*$/
      \ contains=edCommand_exclamation_Arg_Command_Filename,
      \		 edCommand_exclamation_Arg_Command_FilenameEscape,
      \		 edCommand_exclamation_Arg_Command_BacklashEscape

syn match edCommand_exclamation_Arg_Command_Filename  contained
      \ /%/
hi def link edCommand_exclamation_Arg_Command_Filename Special 

syn match   edCommand_exclamation_Arg_Command_FilenameEscape   contained /\\%/
syn match   edCommand_exclamation_Arg_Command_BackslashEscape  contained /\\\\/
hi def link edCommand_exclamation_Arg_Command_FilenameEscape Special 

syn match   edCommand_exclamation_Arg_Previous	contained
      \ /!/
      \ skipwhite
      \ nextgroup=edCommand_exclamation_Arg_Command
hi def link edCommand_exclamation_Arg_Previous Constant
...
hi def link edCommand_iG	  Statement
...
hi def link edCommand_iV	  Statement
...
hi def link edCommand_ampersand   Statement
...
hi def link edCommand_aci_Arg_Text	    Normal
hi def link edCommand_aci_Arg_Text_	    edCommand_aci_Arg_Text_
...
hi def link edCommand_aci_Suffix  edCommandSuffix
hi def link edCommand_s_Suffix	  edCommandSuffix
" }}}
