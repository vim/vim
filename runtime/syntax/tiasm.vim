...
syn match tiasmType "\.ascii"
syn match tiasmType "\.asciz"
syn match tiasmType "\.byte"
syn match tiasmType "\.double"
syn match tiasmType "\.float"
syn match tiasmType "\.hword"
syn match tiasmType "\.int"
syn match tiasmType "\.octa"
syn match tiasmType "\.quad"
syn match tiasmType "\.short"
syn match tiasmType "\.single"
syn match tiasmType "\.space"
...
syn match tiasmStringEscape	"\\\_."			contained
syn match tiasmStringEscape	"\\\%(\o\{3}\|00[89]\)"	contained display
syn match tiasmStringEscape	"\\x\x\+"		contained display

syn region tiasmString		start="\"" end="\"" skip="\\\\\|\\\"" contains=tiasmStringEscape
