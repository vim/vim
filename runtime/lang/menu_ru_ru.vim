...
menutrans O&rphans			&Помощь\ детям
"--------------------
...
menutrans Toggle\ &List\ Mode<Tab>:set\ list!		Показ\ &непечатных\ знаков<Tab>:set\ list!
...
menutrans Toggle\ Tab\ &Expanding<Tab>:set\ et!		Заменять\ символы\ &табуляция\ на\ пробелы<Tab>:set\ et!
...
menutrans Fold\ col&umn\ width				&Ширина\ колонки\ со\ значками\ структуры
...
">>>--------------- Sub of Tools/Diff
menutrans &Update					О&бновить\ содержание\ окон
...
if has("toolbar")
  ...
  fun Do_toolbar_tmenu()
    ...
    tmenu ToolBar.FindNext				Найти следующее совпадение
    tmenu ToolBar.FindPrev				Найти предыдущее совпадение
...
" Tag files dialog
"
let g:menutrans_tags_dialog = "Укажите через запятую наименования индексных файлов"
"
" Text width dialog
"
