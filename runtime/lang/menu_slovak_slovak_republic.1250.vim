...
" Previous Maintainer:  Martin Lacko <lacko@host.sk>
...
" Help menu
menutrans &Help &PomocnÌk
" Help menuitems and dialog {{{1
menutrans &Overview<Tab><F1> &Prehæad<Tab><F1>
menutrans &User\ Manual Po&uûÌvateæsk˝\ manu·l
menutrans &How-to\ Links &Tipy
menutrans &Find\.\.\. &N·jsù\.\.\.
menutrans &Credits PoÔ&akovanie
...
" File menuitems {{{1
menutrans &Open\.\.\.<Tab>:e &Otvoriù\.\.\.<Tab>:e
menutrans Sp&lit-Open\.\.\.<Tab>:sp Ot&voriù\ v\ novom\ okne\.\.\.<Tab>:sp
" menutrans Open\ Tab\.\.\.<Tab>:tabnew TRANSLATION\ MISSING
menutrans &New<Tab>:enew &Nov˝<Tab>:enew
menutrans &Close<Tab>:close &Zatvoriù<Tab>:close
menutrans &Save<Tab>:w &Uloûiù<Tab>:w
menutrans Save\ &As\.\.\.<Tab>:sav Uloûiù\ &ako\.\.\.<Tab>:sav
menutrans Split\ &Diff\ With\.\.\. Otvor&iù\ porovnanie\ v\ novom\ okne\ s\.\.\.
menutrans Split\ Patched\ &By\.\.\. Otvo&riù\ aktualizovanÈ\ s\.\.\.
menutrans &Print &TlaË
menutrans Sa&ve-Exit<Tab>:wqa U&loûiù-Koniec<Tab>:wqa
...
" Edit menuitems {{{1
menutrans &Undo<Tab>u &Sp‰ù<Tab>u
menutrans &Redo<Tab>^R Z&ruöiù\ sp‰ù<Tab>^R
menutrans Rep&eat<Tab>\. &Opakovaù<Tab>\.
menutrans Cu&t<Tab>"+x &Vystrihn˙ù<Tab>"+x
menutrans &Copy<Tab>"+y &KopÌrovaù<Tab>"+y
menutrans &Paste<Tab>"+gP V&loûiù<Tab>"+gP
menutrans Put\ &Before<Tab>[p Vloûiù\ &pred<Tab>[p
menutrans Put\ &After<Tab>]p Vloûiù\ za<Tab>]p
menutrans &Delete<Tab>x Vy&mazaù<Tab>x
menutrans &Select\ All<Tab>ggVG Vy&braù\ vöetko<Tab>ggVG
menutrans &Find\.\.\. &N·jsù\.\.\.
menutrans Find\ and\ Rep&lace\.\.\. N&ahradiù\.\.\.
" menutrans &Find<Tab>/ TRANSLATION\ MISSING
" menutrans Find\ and\ Rep&lace<Tab>:%s TRANSLATION\ MISSING
" menutrans Find\ and\ Rep&lace<Tab>:s TRANSLATION\ MISSING
menutrans Settings\ &Window Mo&ûnosti
" menutrans Startup\ &Settings TRANSLATION\ MISSING

" Edit/Global Settings
menutrans &Global\ Settings &Glob·lne\ moûnosti
" Edit.Global Settings menuitems and dialogs {{{2
menutrans Toggle\ Pattern\ &Highlight<Tab>:set\ hls! Prepn˙ù\ paletu\ zv˝razÚovania<Tab>:set\ hls!
...
menutrans &Context\ Lines &KontextovÈ\ riadky
...
menutrans Insert\ Mode Reûim\ vkladania
menutrans Block\ and\ Insert Blok\ a\ vkladanie
menutrans Always Vûdy
" }}}
menutrans Toggle\ Insert\ &Mode<Tab>:set\ im! Prepn˙ù\ reûi&m\ vkladania<Tab>:set\ im!
" menutrans Toggle\ Vi\ C&ompatibility<Tab>:set\ cp! TRANSLATION\ MISSING
menutrans Search\ &Path\.\.\. Cesta\ &hæadania\.\.\.
menutrans Ta&g\ Files\.\.\. Ta&govÈ\ s˙bory\.\.\.

" GUI options
menutrans Toggle\ &Toolbar Prepn˙ù\ &panel
menutrans Toggle\ &Bottom\ Scrollbar Prepn˙ù\ spodn˝\ posuvnÌk
menutrans Toggle\ &Left\ Scrollbar Prepn˙ù\ æav˝\ posuvnÌk
menutrans Toggle\ &Right\ Scrollbar Prepn˙ù\ prav˝\ posuvnÌk
...
" Boolean options
menutrans Toggle\ Line\ &Numbering<Tab>:set\ nu! Prepn˙ù\ ËÌslova&nie\ riadkov<Tab>:set\ nu!
" menutrans Toggle\ Relati&ve\ Line\ Numbering<Tab>:set\ rnu! TRANSLATION\ MISSING
menutrans Toggle\ &List\ Mode<Tab>:set\ list! Prepn˙ù\ reûim\ &zoznamu<Tab>:set\ list!
...
" other options
menutrans &Shiftwidth &äÌrka\ öiftu
menutrans Soft\ &Tabstop &SoftvÈrov˝\ tabul·tor
menutrans Te&xt\ Width\.\.\. äÌrka\ te&xtu\.\.\.
...
menutrans C&olor\ Scheme Far&ebn·\ schÈma
" menutrans None TRANSLATION\ MISSING
" menutrans Show\ &Keymaps\ in\ Menu TRANSLATION\ MISSING
" menutrans &Keymap TRANSLATION\ MISSING
menutrans Select\ Fo&nt\.\.\. Vy&braù\ pÌsmo\.\.\.
" }}}

" Programming menu
menutrans &Tools &N·stroje
" Tools menuitems {{{1
menutrans &Jump\ to\ This\ Tag<Tab>g^] &SkoËiù\ na\ znaËku<Tab>g^]
menutrans Jump\ &Back<Tab>^T Sk&oËiù\ sp‰ù<Tab>^T
menutrans Build\ &Tags\ File &Vytvoriù\ s˙bor\ znaËiek
...
" open close folds
menutrans &Enable/Disable\ Folds<Tab>zi Zapn˙ù/Vypn˙ù\ vn·rani&e<Tab>zi
menutrans &View\ Cursor\ Line<Tab>zv Zobraziù\ kurzoro&v˝\ riadok<Tab>zv
menutrans Vie&w\ Cursor\ Line\ Only<Tab>zMzx Zobraziù\ iba\ kurzorov˝\ riadok<Tab>zMzx
menutrans C&lose\ More\ Folds<Tab>zm Zatvoriù\ viac\ vnorenÌ<Tab>zm
menutrans &Close\ All\ Folds<Tab>zM Zatvor&iù\ vöetky\ vnorenia<Tab>zM
menutrans O&pen\ More\ Folds<Tab>zr O&tvoriù\ viac\ vnorenÌ<Tab>zr
menutrans &Open\ All\ Folds<Tab>zR &Otvoriù\ vöetky\ vnorenia<Tab>zR
" fold method
menutrans Fold\ Met&hod MetÛ&da\ vn·rania
...
menutrans Ma&rker Zna&ËkovaË
" }}}
" create and delete folds
menutrans Create\ &Fold<Tab>zf Vyt&voriù\ vnorenie<Tab>zf
menutrans &Delete\ Fold<Tab>zd V&ymazaù\ vnorenie<Tab>zd
menutrans Delete\ &All\ Folds<Tab>zD Vymazaù\ vöetky\ vnorenia<Tab>zD
...
menutrans &Update Akt&ualizovaù
menutrans &Get\ Block Zob&raù\ blok
menutrans &Put\ Block &Vloûiù\ blok
" }}}

menutrans &Make<Tab>:make &Make<Tab>:make
menutrans &List\ Errors<Tab>:cl V˝pis\ &ch˝b<Tab>:cl
menutrans L&ist\ Messages<Tab>:cl! V˝p&is\ spr·v<Tab>:cl!
menutrans &Next\ Error<Tab>:cn œa&löia\ chyba<Tab>:cn
menutrans &Previous\ Error<Tab>:cp &Predch·dzaj˙ca\ chyba<Tab>:cp
menutrans &Older\ List<Tab>:cold Sta&röÌ\ zoznam<Tab>:cold
menutrans N&ewer\ List<Tab>:cnew NovöÌ\ &zoznam<Tab>:cnew
menutrans Error\ &Window ChybovÈ\ &okno
" Tools.Error Window menuitems {{{2
menutrans &Update<Tab>:cwin Akt&ualizovaù<Tab>:cwin
menutrans &Open<Tab>:copen &Otvoriù<Tab>:copen
menutrans &Close<Tab>:cclose &Zatvoriù<Tab>:cclose
" }}}
" menutrans Show\ Compiler\ Se&ttings\ in\ Menu TRANSLATION\ MISSING
" menutrans Se&t\ Compiler TRANSLATION\ MISSING
menutrans &Convert\ to\ HEX<Tab>:%!xxd &Konvertovaù\ do\ HEX<Tab>:%!xxd
menutrans Conve&rt\ Back<Tab>:%!xxd\ -r Konve&rtovaù\ sp‰ù<Tab>:%!xxd\ -r
" }}}

" Buffer menu
menutrans &Buffers &Vyrovn·vacia\ pam‰ù
" menutrans Dummy TRANSLATION\ MISSING
" Buffer menuitems and dialog {{{1
menutrans &Refresh\ Menu Obnoviù
menutrans &Delete V&ymazaù
menutrans &Alternate Zmeniù
menutrans &Next œ&alöia
...
" Window menuitems {{{1
menutrans &New<Tab>^Wn &NovÈ<Tab>^Wn
menutrans S&plit<Tab>^Ws &Rozdeliù<Tab>^Ws
menutrans Sp&lit\ To\ #<Tab>^W^^ Ro&zdeliù\ na\ #<Tab>^W^^
menutrans Split\ &Vertically<Tab>^Wv Rozdeliù\ &vertik·lne<Tab>^Wv
menutrans Split\ File\ E&xplorer Otvoriù\ pri&eskumnÌka
menutrans &Close<Tab>^Wc Zatvor&iù<Tab>^Wc
menutrans Close\ &Other(s)<Tab>^Wo Zatvoriù\ i&nÈ<Tab>^Wo
menutrans Move\ &To Presun˙&ù
menutrans &Top<Tab>^WK Na&hor<Tab>^WK
menutrans &Bottom<Tab>^WJ Nado&l<Tab>^WJ
menutrans &Left\ Side<Tab>^WH V&æavo<Tab>^WJ
menutrans &Right\ Side<Tab>^WL Vprav&o<Tab>^WL
menutrans Rotate\ &Up<Tab>^WR Rotova&ù\ nahor<Tab>^WR
menutrans Rotate\ &Down<Tab>^Wr Rotovaù\ na&dol<Tab>^Wr
menutrans &Equal\ Size<Tab>^W= Rovnak·\ v˝ö&ka<Tab>^W=
menutrans &Max\ Height<Tab>^W_ &Maxim·lna\ v˝öka<Tab>^W_
menutrans M&in\ Height<Tab>^W1_ Minim·lna\ v˝&öka<Tab>^W1_
menutrans Max\ &Width<Tab>^W\| Maxim·lna\ öÌrka<Tab>^W\|
menutrans Min\ Widt&h<Tab>^W1\| Minim·lna\ öirka<Tab>^W1\|
" }}}

" The popup menu {{{1
menutrans &Undo &Sp‰ù
menutrans Cu&t &Vystrihn˙ù
menutrans &Copy &KopÌrovaù
menutrans &Paste V&loûiù
menutrans &Delete V&ymazaù
menutrans Select\ Blockwise Vybraù\ blokovo
menutrans Select\ &Word Vybraù\ sl&ovo
" menutrans Select\ &Sentence TRANSLATION\ MISSING
" menutrans Select\ Pa&ragraph TRANSLATION\ MISSING
menutrans Select\ &Line Vybraù\ &riadok
menutrans Select\ &Block Vybraù\ &blok
menutrans Select\ &All Vybraù\ vö&etko
...
if has("toolbar")
  ...
  fun Do_toolbar_tmenu()
    ...
    tmenu ToolBar.Open Otvoriù s˙bor
    tmenu ToolBar.Save Uloûiù s˙bor
    tmenu ToolBar.SaveAll Uloûiù vöetky
    tmenu ToolBar.Print TlaË
    tmenu ToolBar.Undo Sp‰ù
    tmenu ToolBar.Redo Opakovaù
    tmenu ToolBar.Cut Vystrihn˙ù
    tmenu ToolBar.Copy KopÌrovaù
    tmenu ToolBar.Paste Vloûiù
    if !has("gui_athena")
      tmenu ToolBar.Replace Nahradiù...
      tmenu ToolBar.FindNext N·jsù Ôalöie
      tmenu ToolBar.FindPrev N·jsù predch·dzaj˙ce
    endif
    tmenu ToolBar.LoadSesn NaËÌtaù sedenie
    tmenu ToolBar.SaveSesn Uloûiù sedenie
    tmenu ToolBar.RunScript Spustiù skript
    tmenu ToolBar.Make Spustiù make
    tmenu ToolBar.RunCtags Spustiù ctags
    tmenu ToolBar.TagJump SkoËiù na tag pod kurzorom
    tmenu ToolBar.Help PomocnÌk
    tmenu ToolBar.FindHelp N·jsù pomocnÌka k...
  endfun
endif
" }}}
...
menutrans &Off &Vypn˙ù
menutrans &Manual &RuËne
menutrans A&utomatic A&utomaticky
menutrans On/Off\ for\ &This\ File Zapn˙ù/vypn˙ù\ pre\ &tento\ s˙bor
menutrans Co&lor\ Test Test\ &farieb
menutrans &Highlight\ Test &Test\ zv˝razÚovania
menutrans &Convert\ to\ HTML &Previesù\ do\ HTML

" From synmenu.vim
menutrans Set\ '&syntax'\ Only Nastaviù\ iba\ 'syntax'
menutrans Set\ '&filetype'\ Too Nastaviù\ aj\ 'filetype'
