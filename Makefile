...
#   > nmake.exe -lf Make_mvc.mak
# - Run the tests and check the output:
#   > nmake.exe -lf Make_mvc.mak testclean
#   > nmake.exe -lf Make_mvc.mak test
...
# - > cd src
#   > nmake.exe -lf Make_mvc.mak "GUI=yes"
# - Run the tests and check the output:
#   > nmake.exe -lf Make_mvc.mak testclean
#   > nmake.exe -lf Make_mvc.mak testgvim
