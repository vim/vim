...
static char *(highlight_init_light[]) = {
    ...
    CENT("PmenuKind ctermbg=LightMagenta ctermfg=Black",
	 "PmenuKind ctermbg=LightMagenta ctermfg=Black guibg=LightMagenta"),
    CENT("PmenuKindSel ctermbg=LightGrey ctermfg=Black",
	 "PmenuKindSel ctermbg=LightGrey ctermfg=Black guibg=Grey"),
    CENT("PmenuExtra ctermbg=LightMagenta ctermfg=Black",
	 "PmenuExtra ctermbg=LightMagenta ctermfg=Black guibg=LightMagenta"),
    CENT("PmenuExtraSel ctermbg=LightGrey ctermfg=Black",
	 "PmenuExtraSel ctermbg=LightGrey ctermfg=Black guibg=Grey"),
...
static char *(highlight_init_dark[]) = {
    ...
    CENT("PmenuKind ctermbg=Magenta ctermfg=Black",
	 "PmenuKind ctermbg=Magenta ctermfg=Black guibg=Magenta"),
    CENT("PmenuKindSel ctermbg=Black ctermfg=DarkGrey",
	 "PmenuKindSel ctermbg=Black ctermfg=DarkGrey guibg=DarkGrey"),
    CENT("PmenuExtra ctermbg=Magenta ctermfg=Black",
	 "PmenuExtra ctermbg=Magenta ctermfg=Black guibg=Magenta"),
    CENT("PmenuExtraSel ctermbg=Black ctermfg=DarkGrey",
	 "PmenuExtraSel ctermbg=Black ctermfg=DarkGrey guibg=DarkGrey"),
