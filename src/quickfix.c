 ...
 * buffer and ABORT if the quickfix/location list was freed by an autocmd
 ...
 * with the entry.  Returns ABORT if the quickfix/location list was modified by
 * an autocmd.
 */
    static int
qf_jump_open_window(
 ...
 * ABORT if the quickfix/location list is freed by an autocmd when opening
 * the file.
 */
    static int
qf_jump_to_buffer(
