...
# endif
    ...
    {"fmod",		2, 2, FEARG_1,	  &t_any,	f_fmod},
#endif
    {"fnameescape",	1, 1, FEARG_1,	  &t_any,	f_fnameescape},
    {"fnamemodify",	2, 2, FEARG_1,	  &t_any,	f_fnamemodify},
    {"foldclosed",	1, 1, FEARG_1,	  &t_any,	f_foldclosed},
    {"foldclosedend",	1, 1, FEARG_1,	  &t_any,	f_foldclosedend},
    {"foldlevel",	1, 1, FEARG_1,	  &t_any,	f_foldlevel},
    {"foldtext",	0, 0, 0,	  &t_any,	f_foldtext},
    {"foldtextresult",	1, 1, FEARG_1,	  &t_any,	f_foldtextresult},
    {"foreground",	0, 0, 0,	  &t_any,	f_foreground},
    {"funcref",		1, 3, FEARG_1,	  &t_any,	f_funcref},
    {"function",	1, 3, FEARG_1,	  &t_any,	f_function},
    {"garbagecollect",	0, 1, 0,	  &t_any,	f_garbagecollect},
    {"get",		2, 3, FEARG_1,	  &t_any,	f_get},
    {"getbufinfo",	0, 1, 0,	  &t_any,	f_getbufinfo},
    {"getbufline",	2, 3, FEARG_1,	  &t_any,	f_getbufline},
    {"getbufvar",	2, 3, FEARG_1,	  &t_any,	f_getbufvar},
    {"getchangelist",	0, 1, FEARG_1,	  &t_any,	f_getchangelist},
    {"getchar",		0, 1, 0,	  &t_any,	f_getchar},
    {"getcharmod",	0, 0, 0,	  &t_any,	f_getcharmod},
    {"getcharsearch",	0, 0, 0,	  &t_any,	f_getcharsearch},
    {"getcmdline",	0, 0, 0,	  &t_any,	f_getcmdline},
    {"getcmdpos",	0, 0, 0,	  &t_any,	f_getcmdpos},
    {"getcmdtype",	0, 0, 0,	  &t_any,	f_getcmdtype},
    {"getcmdwintype",	0, 0, 0,	  &t_any,	f_getcmdwintype},
    {"getcompletion",	2, 3, FEARG_1,	  &t_any,	f_getcompletion},
    {"getcurpos",	0, 0, 0,	  &t_any,	f_getcurpos},
    {"getcwd",		0, 2, FEARG_1,	  &t_any,	f_getcwd},
    {"getenv",		1, 1, FEARG_1,	  &t_any,	f_getenv},
    {"getfontname",	0, 1, 0,	  &t_any,	f_getfontname},
    {"getfperm",	1, 1, FEARG_1,	  &t_any,	f_getfperm},
    {"getfsize",	1, 1, FEARG_1,	  &t_any,	f_getfsize},
    {"getftime",	1, 1, FEARG_1,	  &t_any,	f_getftime},
    {"getftype",	1, 1, FEARG_1,	  &t_any,	f_getftype},
    {"getimstatus",	0, 0, 0,	  &t_any,	f_getimstatus},
    {"getjumplist",	0, 2, FEARG_1,	  &t_any,	f_getjumplist},
    {"getline",		1, 2, FEARG_1,	  &t_string,	f_getline},
    {"getloclist",	1, 2, 0,	  &t_any,	f_getloclist},
    {"getmatches",	0, 1, 0,	  &t_any,	f_getmatches},
    {"getmousepos",	0, 0, 0,	  &t_any,	f_getmousepos},
    ...
    {"hlID",		1, 1, FEARG_1,	  &t_any,	f_hlID},
    {"hlexists",	1, 1, FEARG_1,	  &t_any,	f_hlexists},
    {"hostname",	0, 0, 0,	  &t_any,	f_hostname},
    {"iconv",		3, 3, FEARG_1,	  &t_any,	f_iconv},
    {"indent",		1, 1, FEARG_1,	  &t_any,	f_indent},
    {"index",		2, 4, FEARG_1,	  &t_any,	f_index},
    {"input",		1, 3, FEARG_1,	  &t_any,	f_input},
    {"inputdialog",	1, 3, FEARG_1,	  &t_any,	f_inputdialog},
    {"inputlist",	1, 1, FEARG_1,	  &t_any,	f_inputlist},
    {"inputrestore",	0, 0, 0,	  &t_any,	f_inputrestore},
    {"inputsave",	0, 0, 0,	  &t_any,	f_inputsave},
    {"inputsecret",	1, 2, FEARG_1,	  &t_any,	f_inputsecret},
    {"insert",		2, 3, FEARG_1,	  &t_any,	f_insert},
    {"interrupt",	0, 0, 0,	  &t_any,	f_interrupt},
    {"invert",		1, 1, FEARG_1,	  &t_any,	f_invert},
    {"isdirectory",	1, 1, FEARG_1,	  &t_any,	f_isdirectory},
#if defined(FEAT_FLOAT) && defined(HAVE_MATH_H)
    {"isinf",		1, 1, FEARG_1,	  &t_any,	f_isinf},
#endif
    {"islocked",	1, 1, FEARG_1,	  &t_any,	f_islocked},
#if defined(FEAT_FLOAT) && defined(HAVE_MATH_H)
    {"isnan",		1, 1, FEARG_1,	  &t_any,	f_isnan},
#endif
    {"items",		1, 1, FEARG_1,	  &t_any,	f_items},
#ifdef FEAT_JOB_CHANNEL
    {"job_getchannel",	1, 1, FEARG_1,	  &t_any,	f_job_getchannel},
    {"job_info",	0, 1, FEARG_1,	  &t_any,	f_job_info},
    {"job_setoptions",	2, 2, FEARG_1,	  &t_any,	f_job_setoptions},
    {"job_start",	1, 2, FEARG_1,	  &t_any,	f_job_start},
    {"job_status",	1, 1, FEARG_1,	  &t_any,	f_job_status},
    {"job_stop",	1, 2, FEARG_1,	  &t_any,	f_job_stop},
#endif
    {"join",		1, 2, FEARG_1,	  &t_any,	f_join},
    {"js_decode",	1, 1, FEARG_1,	  &t_any,	f_js_decode},
    {"js_encode",	1, 1, FEARG_1,	  &t_any,	f_js_encode},
    {"json_decode",	1, 1, FEARG_1,	  &t_any,	f_json_decode},
    {"json_encode",	1, 1, FEARG_1,	  &t_any,	f_json_encode},
    {"keys",		1, 1, FEARG_1,	  &t_any,	f_keys},
    {"last_buffer_nr",	0, 0, 0,	  &t_any,	f_last_buffer_nr}, // obsolete
    {"len",		1, 1, FEARG_1,	  &t_number,	f_len},
    {"libcall",		3, 3, FEARG_3,	  &t_any,	f_libcall},
    {"libcallnr",	3, 3, FEARG_3,	  &t_any,	f_libcallnr},
    {"line",		1, 2, FEARG_1,	  &t_any,	f_line},
    {"line2byte",	1, 1, FEARG_1,	  &t_any,	f_line2byte},
    {"lispindent",	1, 1, FEARG_1,	  &t_any,	f_lispindent},
    {"list2str",	1, 2, FEARG_1,	  &t_any,	f_list2str},
    {"listener_add",	1, 2, FEARG_2,	  &t_any,	f_listener_add},
    {"listener_flush",	0, 1, FEARG_1,	  &t_any,	f_listener_flush},
    {"listener_remove",	1, 1, FEARG_1,	  &t_any,	f_listener_remove},
    {"localtime",	0, 0, 0,	  &t_any,	f_localtime},
#ifdef FEAT_FLOAT
    {"log",		1, 1, FEARG_1,	  &t_any,	f_log},
    {"log10",		1, 1, FEARG_1,	  &t_any,	f_log10},
#endif
#ifdef FEAT_LUA
    {"luaeval",		1, 2, FEARG_1,	  &t_any,	f_luaeval},
#endif
    {"map",		2, 2, FEARG_1,	  &t_any,	f_map},
    {"maparg",		1, 4, FEARG_1,	  &t_any,	f_maparg},
    {"mapcheck",	1, 3, FEARG_1,	  &t_any,	f_mapcheck},
    {"match",		2, 4, FEARG_1,	  &t_any,	f_match},
    {"matchadd",	2, 5, FEARG_1,	  &t_any,	f_matchadd},
    {"matchaddpos",	2, 5, FEARG_1,	  &t_any,	f_matchaddpos},
    {"matcharg",	1, 1, FEARG_1,	  &t_any,	f_matcharg},
    {"matchdelete",	1, 2, FEARG_1,	  &t_any,	f_matchdelete},
    {"matchend",	2, 4, FEARG_1,	  &t_any,	f_matchend},
    {"matchlist",	2, 4, FEARG_1,	  &t_any,	f_matchlist},
    {"matchstr",	2, 4, FEARG_1,	  &t_any,	f_matchstr},
    {"matchstrpos",	2, 4, FEARG_1,	  &t_any,	f_matchstrpos},
    {"max",		1, 1, FEARG_1,	  &t_any,	f_max},
    {"min",		1, 1, FEARG_1,	  &t_any,	f_min},
    {"mkdir",		1, 3, FEARG_1,	  &t_any,	f_mkdir},
    {"mode",		0, 1, FEARG_1,	  &t_any,	f_mode},
#ifdef FEAT_MZSCHEME
    {"mzeval",		1, 1, FEARG_1,	  &t_any,	f_mzeval},
#endif
    {"nextnonblank",	1, 1, FEARG_1,	  &t_any,	f_nextnonblank},
    {"nr2char",		1, 2, FEARG_1,	  &t_any,	f_nr2char},
    {"or",		2, 2, FEARG_1,	  &t_any,	f_or},
    {"pathshorten",	1, 1, FEARG_1,	  &t_any,	f_pathshorten},
#ifdef FEAT_PERL
    {"perleval",	1, 1, FEARG_1,	  &t_any,	f_perleval},
#endif
#ifdef FEAT_PROP_POPUP
    {"popup_atcursor",	2, 2, FEARG_1,	  &t_any,	f_popup_atcursor},
    {"popup_beval",	2, 2, FEARG_1,	  &t_any,	f_popup_beval},
    {"popup_clear",	0, 0, 0,	  &t_any,	f_popup_clear},
    {"popup_close",	1, 2, FEARG_1,	  &t_any,	f_popup_close},
    {"popup_create",	2, 2, FEARG_1,	  &t_any,	f_popup_create},
    {"popup_dialog",	2, 2, FEARG_1,	  &t_any,	f_popup_dialog},
    {"popup_filter_menu", 2, 2, 0,	  &t_any,	f_popup_filter_menu},
    {"popup_filter_yesno", 2, 2, 0,	  &t_any,	f_popup_filter_yesno},
    {"popup_findinfo",	0, 0, 0,	  &t_any,	f_popup_findinfo},
    {"popup_findpreview", 0, 0, 0,	  &t_any,	f_popup_findpreview},
    {"popup_getoptions", 1, 1, FEARG_1,	  &t_any,	f_popup_getoptions},
    {"popup_getpos",	1, 1, FEARG_1,	  &t_any,	f_popup_getpos},
    {"popup_hide",	1, 1, FEARG_1,	  &t_any,	f_popup_hide},
    {"popup_locate",	2, 2, 0,	  &t_any,	f_popup_locate},
    {"popup_menu",	2, 2, FEARG_1,	  &t_any,	f_popup_menu},
    {"popup_move",	2, 2, FEARG_1,	  &t_any,	f_popup_move},
    {"popup_notification", 2, 2, FEARG_1, &t_any,	f_popup_notification},
    {"popup_setoptions", 2, 2, FEARG_1,	  &t_any,	f_popup_setoptions},
    {"popup_settext",	2, 2, FEARG_1,	  &t_any,	f_popup_settext},
    {"popup_show",	1, 1, FEARG_1,	  &t_any,	f_popup_show},
#endif
#ifdef FEAT_FLOAT
    {"pow",		2, 2, FEARG_1,	  &t_any,	f_pow},
#endif
    {"prevnonblank",	1, 1, FEARG_1,	  &t_any,	f_prevnonblank},
    {"printf",		1, 19, FEARG_2,	  &t_any,	f_printf},
#ifdef FEAT_JOB_CHANNEL
    {"prompt_setcallback", 2, 2, FEARG_1, &t_any,	 f_prompt_setcallback},
    {"prompt_setinterrupt", 2, 2, FEARG_1,&t_any,	 f_prompt_setinterrupt},
    {"prompt_setprompt", 2, 2, FEARG_1,	  &t_any,	 f_prompt_setprompt},
#endif
#ifdef FEAT_PROP_POPUP
    {"prop_add",	3, 3, FEARG_1,	  &t_any,	f_prop_add},
    {"prop_clear",	1, 3, FEARG_1,	  &t_any,	f_prop_clear},
    {"prop_list",	1, 2, FEARG_1,	  &t_any,	f_prop_list},
    {"prop_remove",	1, 3, FEARG_1,	  &t_any,	f_prop_remove},
    {"prop_type_add",	2, 2, FEARG_1,	  &t_any,	f_prop_type_add},
    {"prop_type_change", 2, 2, FEARG_1,	  &t_any,	f_prop_type_change},
    {"prop_type_delete", 1, 2, FEARG_1,	  &t_any,	f_prop_type_delete},
    {"prop_type_get",	1, 2, FEARG_1,	  &t_any,	f_prop_type_get},
    {"prop_type_list",	0, 1, FEARG_1,	  &t_any,	f_prop_type_list},
#endif
    {"pum_getpos",	0, 0, 0,	  &t_any,	f_pum_getpos},
    {"pumvisible",	0, 0, 0,	  &t_any,	f_pumvisible},
#ifdef FEAT_PYTHON3
...
#endif
    {"rand",		0, 1, FEARG_1,	  &t_any,	f_rand},
    {"range",		1, 3, FEARG_1,	  &t_list_number,	f_range},
    {"readdir",		1, 2, FEARG_1,	  &t_any,	f_readdir},
    {"readfile",	1, 3, FEARG_1,	  &t_any,	f_readfile},
    {"reg_executing",	0, 0, 0,	  &t_any,	f_reg_executing},
    {"reg_recording",	0, 0, 0,	  &t_any,	f_reg_recording},
    {"reltime",		0, 2, FEARG_1,	  &t_any,	f_reltime},
#ifdef FEAT_FLOAT
    {"reltimefloat",	1, 1, FEARG_1,	  &t_any,	f_reltimefloat},
#endif
    {"reltimestr",	1, 1, FEARG_1,	  &t_any,	f_reltimestr},
    {"remote_expr",	2, 4, FEARG_1,	  &t_any,	f_remote_expr},
    {"remote_foreground", 1, 1, FEARG_1,  &t_any,	f_remote_foreground},
    {"remote_peek",	1, 2, FEARG_1,	  &t_any,	f_remote_peek},
    {"remote_read",	1, 2, FEARG_1,	  &t_any,	f_remote_read},
    {"remote_send",	2, 3, FEARG_1,	  &t_any,	f_remote_send},
    {"remote_startserver", 1, 1, FEARG_1, &t_any,	 f_remote_startserver},
    {"remove",		2, 3, FEARG_1,	  &t_any,	f_remove},
    {"rename",		2, 2, FEARG_1,	  &t_any,	f_rename},
    {"repeat",		2, 2, FEARG_1,	  &t_any,	f_repeat},
    {"resolve",		1, 1, FEARG_1,	  &t_any,	f_resolve},
    {"reverse",		1, 1, FEARG_1,	  &t_any,	f_reverse},
#ifdef FEAT_FLOAT
    {"round",		1, 1, FEARG_1,	  &t_any,	f_round},
#endif
#ifdef FEAT_RUBY
    {"rubyeval",	1, 1, FEARG_1,	  &t_any,	f_rubyeval},
#endif
    {"screenattr",	2, 2, FEARG_1,	  &t_any,	f_screenattr},
    {"screenchar",	2, 2, FEARG_1,	  &t_any,	f_screenchar},
    {"screenchars",	2, 2, FEARG_1,	  &t_any,	f_screenchars},
    {"screencol",	0, 0, 0,	  &t_any,	f_screencol},
    {"screenpos",	3, 3, FEARG_1,	  &t_any,	f_screenpos},
    {"screenrow",	0, 0, 0,	  &t_any,	f_screenrow},
    {"screenstring",	2, 2, FEARG_1,	  &t_any,	f_screenstring},
    {"search",		1, 4, FEARG_1,	  &t_any,	f_search},
    {"searchdecl",	1, 3, FEARG_1,	  &t_any,	f_searchdecl},
    {"searchpair",	3, 7, 0,	  &t_any,	f_searchpair},
    {"searchpairpos",	3, 7, 0,	  &t_any,	f_searchpairpos},
    {"searchpos",	1, 4, FEARG_1,	  &t_any,	f_searchpos},
    {"server2client",	2, 2, FEARG_1,	  &t_any,	f_server2client},
    {"serverlist",	0, 0, 0,	  &t_any,	f_serverlist},
    {"setbufline",	3, 3, FEARG_3,	  &t_any,	f_setbufline},
    {"setbufvar",	3, 3, FEARG_3,	  &t_any,	f_setbufvar},
    {"setcharsearch",	1, 1, FEARG_1,	  &t_any,	f_setcharsearch},
    {"setcmdpos",	1, 1, FEARG_1,	  &t_any,	f_setcmdpos},
    {"setenv",		2, 2, FEARG_2,	  &t_any,	f_setenv},
    {"setfperm",	2, 2, FEARG_1,	  &t_any,	f_setfperm},
    {"setline",		2, 2, FEARG_2,	  &t_any,	f_setline},
    {"setloclist",	2, 4, FEARG_2,	  &t_any,	f_setloclist},
    {"setmatches",	1, 2, FEARG_1,	  &t_any,	f_setmatches},
    {"setpos",		2, 2, FEARG_2,	  &t_any,	f_setpos},
    {"setqflist",	1, 3, FEARG_1,	  &t_any,	f_setqflist},
    {"setreg",		2, 3, FEARG_2,	  &t_any,	f_setreg},
    {"settabvar",	3, 3, FEARG_3,	  &t_any,	f_settabvar},
    {"settabwinvar",	4, 4, FEARG_4,	  &t_any,	f_settabwinvar},
    {"settagstack",	2, 3, FEARG_2,	  &t_any,	f_settagstack},
    {"setwinvar",	3, 3, FEARG_3,	  &t_any,	f_setwinvar},
#ifdef FEAT_CRYPT
    {"sha256",		1, 1, FEARG_1,	  &t_any,	f_sha256},
#endif
    {"shellescape",	1, 2, FEARG_1,	  &t_any,	f_shellescape},
    {"shiftwidth",	0, 1, FEARG_1,	  &t_any,	f_shiftwidth},
#ifdef FEAT_SIGNS
    {"sign_define",	1, 2, FEARG_1,	  &t_any,	f_sign_define},
    {"sign_getdefined",	0, 1, FEARG_1,	  &t_any,	f_sign_getdefined},
    {"sign_getplaced",	0, 2, FEARG_1,	  &t_any,	f_sign_getplaced},
    {"sign_jump",	3, 3, FEARG_1,	  &t_any,	f_sign_jump},
    {"sign_place",	4, 5, FEARG_1,	  &t_any,	f_sign_place},
    {"sign_placelist",	1, 1, FEARG_1,	  &t_any,	f_sign_placelist},
    {"sign_undefine",	0, 1, FEARG_1,	  &t_any,	f_sign_undefine},
    {"sign_unplace",	1, 2, FEARG_1,	  &t_any,	f_sign_unplace},
    {"sign_unplacelist", 1, 2, FEARG_1,	  &t_any,	f_sign_unplacelist},
#endif
    {"simplify",	1, 1, 0,	  &t_any,	f_simplify},
#ifdef FEAT_FLOAT
    {"sin",		1, 1, FEARG_1,	  &t_any,	f_sin},
    {"sinh",		1, 1, FEARG_1,	  &t_any,	f_sinh},
#endif
    {"sort",		1, 3, FEARG_1,	  &t_any,	f_sort},
#ifdef FEAT_SOUND
    {"sound_clear",	0, 0, 0,	  &t_any,	f_sound_clear},
    {"sound_playevent",	1, 2, FEARG_1,	  &t_any,	f_sound_playevent},
    {"sound_playfile",	1, 2, FEARG_1,	  &t_any,	f_sound_playfile},
    {"sound_stop",	1, 1, FEARG_1,	  &t_any,	f_sound_stop},
#endif
    {"soundfold",	1, 1, FEARG_1,	  &t_any,	f_soundfold},
    {"spellbadword",	0, 1, FEARG_1,	  &t_any,	f_spellbadword},
    {"spellsuggest",	1, 3, FEARG_1,	  &t_any,	f_spellsuggest},
    {"split",		1, 3, FEARG_1,	  &t_any,	f_split},
#ifdef FEAT_FLOAT
    {"sqrt",		1, 1, FEARG_1,	  &t_any,	f_sqrt},
#endif
    {"srand",		0, 1, FEARG_1,	  &t_any,	f_srand},
    {"state",		0, 1, FEARG_1,	  &t_any,	f_state},
#ifdef FEAT_FLOAT
    {"str2float",	1, 1, FEARG_1,	  &t_any,	f_str2float},
#endif
    {"str2list",	1, 2, FEARG_1,	  &t_any,	f_str2list},
    {"str2nr",		1, 3, FEARG_1,	  &t_any,	f_str2nr},
    {"strcharpart",	2, 3, FEARG_1,	  &t_any,	f_strcharpart},
    {"strchars",	1, 2, FEARG_1,	  &t_any,	f_strchars},
    {"strdisplaywidth",	1, 2, FEARG_1,	  &t_any,	f_strdisplaywidth},
#ifdef HAVE_STRFTIME
    {"strftime",	1, 2, FEARG_1,	  &t_any,	f_strftime},
#endif
    {"strgetchar",	2, 2, FEARG_1,	  &t_any,	f_strgetchar},
    {"stridx",		2, 3, FEARG_1,	  &t_any,	f_stridx},
    {"string",		1, 1, FEARG_1,	  &t_any,	f_string},
    {"strlen",		1, 1, FEARG_1,	  &t_any,	f_strlen},
    {"strpart",		2, 3, FEARG_1,	  &t_any,	f_strpart},
#ifdef HAVE_STRPTIME
    {"strptime",	2, 2, FEARG_1,	  &t_any,	f_strptime},
#endif
    {"strridx",		2, 3, FEARG_1,	  &t_any,	f_strridx},
    {"strtrans",	1, 1, FEARG_1,	  &t_any,	f_strtrans},
    {"strwidth",	1, 1, FEARG_1,	  &t_any,	f_strwidth},
    {"submatch",	1, 2, FEARG_1,	  &t_any,	f_submatch},
    {"substitute",	4, 4, FEARG_1,	  &t_any,	f_substitute},
    {"swapinfo",	1, 1, FEARG_1,	  &t_any,	f_swapinfo},
    {"swapname",	1, 1, FEARG_1,	  &t_any,	f_swapname},
    {"synID",		3, 3, 0,	  &t_any,	f_synID},
    {"synIDattr",	2, 3, FEARG_1,	  &t_any,	f_synIDattr},
    {"synIDtrans",	1, 1, FEARG_1,	  &t_any,	f_synIDtrans},
    {"synconcealed",	2, 2, 0,	  &t_any,	f_synconcealed},
    {"synstack",	2, 2, 0,	  &t_any,	f_synstack},
    {"system",		1, 2, FEARG_1,	  &t_any,	f_system},
    {"systemlist",	1, 2, FEARG_1,	  &t_any,	f_systemlist},
    {"tabpagebuflist",	0, 1, FEARG_1,	  &t_any,	f_tabpagebuflist},
    {"tabpagenr",	0, 1, 0,	  &t_any,	f_tabpagenr},
    {"tabpagewinnr",	1, 2, FEARG_1,	  &t_any,	f_tabpagewinnr},
    {"tagfiles",	0, 0, 0,	  &t_any,	f_tagfiles},
    {"taglist",		1, 2, FEARG_1,	  &t_any,	f_taglist},
#ifdef FEAT_FLOAT
    {"tan",		1, 1, FEARG_1,	  &t_any,	f_tan},
    {"tanh",		1, 1, FEARG_1,	  &t_any,	f_tanh},
#endif
    {"tempname",	0, 0, 0,	  &t_any,	f_tempname},
#ifdef FEAT_TERMINAL
    {"term_dumpdiff",	2, 3, FEARG_1,	  &t_any,	f_term_dumpdiff},
    {"term_dumpload",	1, 2, FEARG_1,	  &t_any,	f_term_dumpload},
    {"term_dumpwrite",	2, 3, FEARG_2,	  &t_any,	f_term_dumpwrite},
    {"term_getaltscreen", 1, 1, FEARG_1,  &t_any,	f_term_getaltscreen},
# if defined(FEAT_GUI) || defined(FEAT_TERMGUICOLORS)
    {"term_getansicolors", 1, 1, FEARG_1, &t_any,	f_term_getansicolors},
# endif
    {"term_getattr",	2, 2, FEARG_1,	  &t_any,	f_term_getattr},
    {"term_getcursor",	1, 1, FEARG_1,	  &t_any,	f_term_getcursor},
    {"term_getjob",	1, 1, FEARG_1,	  &t_any,	f_term_getjob},
    {"term_getline",	2, 2, FEARG_1,	  &t_any,	f_term_getline},
    {"term_getscrolled", 1, 1, FEARG_1,	  &t_any,	f_term_getscrolled},
    {"term_getsize",	1, 1, FEARG_1,	  &t_any,	f_term_getsize},
    {"term_getstatus",	1, 1, FEARG_1,	  &t_any,	f_term_getstatus},
    {"term_gettitle",	1, 1, FEARG_1,	  &t_any,	f_term_gettitle},
    {"term_gettty",	1, 2, FEARG_1,	  &t_any,	f_term_gettty},
    {"term_list",	0, 0, 0,	  &t_any,	f_term_list},
    {"term_scrape",	2, 2, FEARG_1,	  &t_any,	f_term_scrape},
    {"term_sendkeys",	2, 2, FEARG_1,	  &t_any,	f_term_sendkeys},
# if defined(FEAT_GUI) || defined(FEAT_TERMGUICOLORS)
    {"term_setansicolors", 2, 2, FEARG_1, &t_any,	f_term_setansicolors},
# endif
    {"term_setapi",	2, 2, FEARG_1,	  &t_any,	f_term_setapi},
    {"term_setkill",	2, 2, FEARG_1,	  &t_any,	f_term_setkill},
    {"term_setrestore",	2, 2, FEARG_1,	  &t_any,	f_term_setrestore},
    {"term_setsize",	3, 3, FEARG_1,	  &t_any,	f_term_setsize},
    {"term_start",	1, 2, FEARG_1,	  &t_any,	f_term_start},
    {"term_wait",	1, 2, FEARG_1,	  &t_any,	f_term_wait},
#endif
    {"test_alloc_fail",	3, 3, FEARG_1,	  &t_any,	f_test_alloc_fail},
    {"test_autochdir",	0, 0, 0,	  &t_any,	f_test_autochdir},
    {"test_feedinput",	1, 1, FEARG_1,	  &t_any,	f_test_feedinput},
    {"test_garbagecollect_now",	0, 0, 0,  &t_any,	f_test_garbagecollect_now},
    {"test_garbagecollect_soon", 0, 0, 0, &t_any,	f_test_garbagecollect_soon},
    {"test_getvalue",	1, 1, FEARG_1,	  &t_any,	f_test_getvalue},
    {"test_ignore_error", 1, 1, FEARG_1,  &t_any,	f_test_ignore_error},
    {"test_null_blob",	0, 0, 0,	  &t_any,	f_test_null_blob},
#ifdef FEAT_JOB_CHANNEL
    {"test_null_channel", 0, 0, 0,	  &t_any,	f_test_null_channel},
#endif
    {"test_null_dict",	0, 0, 0,	  &t_any,	f_test_null_dict},
#ifdef FEAT_JOB_CHANNEL
    {"test_null_job",	0, 0, 0,	  &t_any,	f_test_null_job},
#endif
    {"test_null_list",	0, 0, 0,	  &t_any,	f_test_null_list},
    {"test_null_partial", 0, 0, 0,	  &t_any,	f_test_null_partial},
    {"test_null_string", 0, 0, 0,	  &t_any,	f_test_null_string},
    {"test_option_not_set", 1, 1, FEARG_1,&t_any,	 f_test_option_not_set},
    {"test_override",	2, 2, FEARG_2,	  &t_any,	f_test_override},
    {"test_refcount",	1, 1, FEARG_1,	  &t_any,	f_test_refcount},
#ifdef FEAT_GUI
    {"test_scrollbar",	3, 3, FEARG_2,	  &t_any,	f_test_scrollbar},
#endif
    {"test_setmouse",	2, 2, 0,	  &t_any,	f_test_setmouse},
    {"test_settime",	1, 1, FEARG_1,	  &t_any,	f_test_settime},
#ifdef FEAT_TIMERS
    {"timer_info",	0, 1, FEARG_1,	  &t_any,	f_timer_info},
    {"timer_pause",	2, 2, FEARG_1,	  &t_any,	f_timer_pause},
    {"timer_start",	2, 3, FEARG_1,	  &t_any,	f_timer_start},
    {"timer_stop",	1, 1, FEARG_1,	  &t_any,	f_timer_stop},
    {"timer_stopall",	0, 0, 0,	  &t_any,	f_timer_stopall},
#endif
    {"tolower",		1, 1, FEARG_1,	  &t_any,	f_tolower},
    {"toupper",		1, 1, FEARG_1,	  &t_any,	f_toupper},
    {"tr",		3, 3, FEARG_1,	  &t_any,	f_tr},
    {"trim",		1, 2, FEARG_1,	  &t_any,	f_trim},
#ifdef FEAT_FLOAT
    {"trunc",		1, 1, FEARG_1,	  &t_any,	f_trunc},
#endif
    {"type",		1, 1, FEARG_1,	  &t_any,	f_type},
    {"undofile",	1, 1, FEARG_1,	  &t_any,	f_undofile},
    {"undotree",	0, 0, 0,	  &t_any,	f_undotree},
    {"uniq",		1, 3, FEARG_1,	  &t_any,	f_uniq},
    {"values",		1, 1, FEARG_1,	  &t_any,	f_values},
    {"virtcol",		1, 1, FEARG_1,	  &t_any,	f_virtcol},
    {"visualmode",	0, 1, 0,	  &t_any,	f_visualmode},
    {"wildmenumode",	0, 0, 0,	  &t_any,	f_wildmenumode},
    {"win_execute",	2, 3, FEARG_2,	  &t_any,	f_win_execute},
    {"win_findbuf",	1, 1, FEARG_1,	  &t_any,	f_win_findbuf},
    {"win_getid",	0, 2, FEARG_1,	  &t_any,	f_win_getid},
    {"win_gotoid",	1, 1, FEARG_1,	  &t_any,	f_win_gotoid},
    {"win_id2tabwin",	1, 1, FEARG_1,	  &t_any,	f_win_id2tabwin},
    {"win_id2win",	1, 1, FEARG_1,	  &t_any,	f_win_id2win},
    {"win_screenpos",	1, 1, FEARG_1,	  &t_any,	f_win_screenpos},
    {"win_splitmove",   2, 3, FEARG_1,    &t_any,	f_win_splitmove},
    {"winbufnr",	1, 1, FEARG_1,	  &t_any,	f_winbufnr},
    {"wincol",		0, 0, 0,	  &t_any,	f_wincol},
    {"windowsversion",	0, 0, 0,	  &t_any,	f_windowsversion},
    {"winheight",	1, 1, FEARG_1,	  &t_any,	f_winheight},
    {"winlayout",	0, 1, FEARG_1,	  &t_any,	f_winlayout},
    {"winline",		0, 0, 0,	  &t_any,	f_winline},
    {"winnr",		0, 1, FEARG_1,	  &t_any,	f_winnr},
    {"winrestcmd",	0, 0, 0,	  &t_any,	f_winrestcmd},
    {"winrestview",	1, 1, FEARG_1,	  &t_any,	f_winrestview},
    {"winsaveview",	0, 0, 0,	  &t_any,	f_winsaveview},
    {"winwidth",	1, 1, FEARG_1,	  &t_any,	f_winwidth},
    {"wordcount",	0, 0, 0,	  &t_any,	f_wordcount},
    {"writefile",	2, 3, FEARG_1,	  &t_any,	f_writefile},
    {"xor",		2, 2, FEARG_1,	  &t_any,	f_xor},
};
