...
# endif
    ...
    DICT_ADD_NUMBER_KEYLITERAL(rettv->vval.v_dict, "current", stat.cur);
    DICT_ADD_NUMBER_KEYLITERAL(rettv->vval.v_dict, "total", stat.cnt);
    DICT_ADD_NUMBER_KEYLITERAL(rettv->vval.v_dict, "exact_match", stat.exact_match);
    DICT_ADD_NUMBER_KEYLITERAL(rettv->vval.v_dict, "incomplete", stat.incomplete);
    DICT_ADD_NUMBER_KEYLITERAL(rettv->vval.v_dict, "maxcount", stat.last_maxcount);
