...
EXCMD(CMD_botright,	"botright",	ex_wrongmodifier,
	EX_NEEDARG|EX_EXTRA|EX_NOTRLCOM,
	ADDR_NONE),
EXCMD(CMD_bexit,		"bxit",		ex_bexit,
	EX_ARGOPT|EX_BANG|EX_RANGE|EX_BUFNAME|EX_BUFUNL|EX_CMDWIN|EX_COUNT|EX_DFLALL|EX_EXTRA|EX_LOCK_OK|EX_TRLBAR|EX_WHOLEFOLD|EX_FILE1,
	ADDR_OTHER),
