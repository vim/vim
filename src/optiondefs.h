...
#define PV_VLIST	OPT_WIN(WV_VLIST)
#ifdef FEAT_ARABIC
...
# endif
    ...
    {"visualbell",  "vb",   P_BOOL|P_VI_DEF,
			    ...
			    {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"visuallist",  NULL,   P_BOOL|P_VI_DEF|P_RWIN,
			    (char_u *)VAR_WIN, PV_VLIST, NULL, NULL,
			    {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
