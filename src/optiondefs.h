...
# endif
    ...
    {"regexpengine", "re",  P_NUM|P_VI_DEF,
			    ...
			    {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"regputfunc", "rpf",   P_STRING|P_ALLOCED|P_VI_DEF|P_SECURE|P_FUNC,
			    (char_u *)&p_rpf, PV_NONE, did_set_regxfunc, NULL,
			    {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"regyankfunc", "ryf",  P_STRING|P_ALLOCED|P_VI_DEF|P_SECURE|P_FUNC,
			    (char_u *)&p_ryf, PV_NONE, did_set_regxfunc, NULL,
			    {(char_u *)"", (char_u *)0L} SCTX_INIT},
