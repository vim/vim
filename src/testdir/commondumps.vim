...
#	alias git_vimdiff="git difftool -x 'vimdiff -S /tmp/vim/src/testdir/commondumps.vim -o --'"
#
...
if v:progname =~? '\<vimdiff$'
  # Let "vimdiff" render other files.
  if copy(v:argv)
  ...
  # Always stop from further sourcing this script for "vimdiff".
  finish
endif
