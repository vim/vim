...
def Test_generic_class_instance()
  ...
  END
  v9.CheckSourceFailure(lines, "E1582: Too many types specified for generic class 'Foo'", 4)
  ...
  lines =<< trim END
    ...
    var f = Foo<number>.new()
  END
  v9.CheckSourceFailure(lines, "E1583: Not enough types specified for generic class 'Foo'", 4)
  ...
  lines =<< trim END
    ...
    var f = Foo.new()
  END
  v9.CheckSourceFailure(lines, "E1580: Type arguments missing for generic class 'Foo'", 4)
...
def Test_generic_class_failure_in_def_function()
  ...
  lines =<< trim END
    ...
    Fn()
  END
  v9.CheckSourceFailure(lines, "E1582: Too many types specified for generic class 'Foo'", 1)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, "E1583: Not enough types specified for generic class 'Foo'", 1)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, "E1580: Type arguments missing for generic class 'Foo'", 1)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1581: Not a generic class: Foo', 1)
...
def Test_generic_class_extend()
  ...
  lines =<< trim END
    ...
    endclass
  END
  v9.CheckSourceFailure(lines, 'E1581: Not a generic class: A', 7)
  ...
  lines =<< trim END
    ...
    endclass
  END
  v9.CheckSourceFailure(lines, "E1582: Too many types specified for generic class 'A'", 7)
  ...
  lines =<< trim END
    ...
    endclass
  END
  v9.CheckSourceFailure(lines, "E1583: Not enough types specified for generic class 'A'", 7)
  ...
  lines =<< trim END
    ...
    endclass
  END
  v9.CheckSourceFailure(lines, "E1580: Type arguments missing for generic class 'A'", 7)
enddef
