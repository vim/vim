...
" Compare the help forms "forms" of function "name" with what exists_info()
...
" Test that the arguments of global_functions[], as exists_info() reports
