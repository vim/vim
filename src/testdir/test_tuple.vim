...
func Test_tuple_declaration_error()
  ...
  call v9.CheckLegacyAndVim9Failure(lines, [
        \ "E1526: Missing comma in Tuple: 'c')",
        \ "E1526: Missing comma in Tuple: 'c')",
        \ "E1526: Missing comma in Tuple: 'c')"])
  ...
  let lines =<< trim END
    ...
    defcompile
  END
  call v9.CheckDefFailure(lines, 'E1004: White space required before and after ''*'' at "*2, 2)"')
...
func Test_tuple_index_error()
  ...
  let lines =<< trim END
    ...
    Fn(('a', 'b', 'c'))
  END
  call v9.CheckSourceFailure(lines, 'E1518: Tuple index out of range: 3')
  ...
  let lines =<< trim END
    ...
    Fn(('a', 'b', 'c'))
  END
  call v9.CheckSourceFailure(lines, 'E1518: Tuple index out of range: -4')
  ...
  let lines =<< trim END
    ...
    Foo()
  END
  call v9.CheckSourceFailure(lines, 'E1518: Tuple index out of range: 0')
  ...
  END
  call v9.CheckLegacyAndVim9Failure(lines, [
        \ 'E1518: Tuple index out of range: 0',
        \ 'E1518: Tuple index out of range: 0',
        \ 'E1518: Tuple index out of range: 0'])
...
func Test_tuple_concatenate()
  ...
  let lines =<< trim END
    vim9script
    var t: tuple<number> = (1, 2) + ('a', 'b')
  END
  call v9.CheckSourceScriptFailure(lines, 'E1012: Type mismatch; expected tuple<number> but got tuple<any>')
  ...
  let lines =<< trim END
    ...
    Fn()
  END
  call v9.CheckSourceFailure(lines, 'E1012: Type mismatch; expected tuple<number> but got tuple<any>')
...
func Test_multi_assign_from_tuple()
  ...
  END
  call v9.CheckLegacyAndVim9Failure(lines, [
        \ 'E1536: Less targets than Tuple items',
  ...
  END
  call v9.CheckLegacyAndVim9Failure(lines, [
        \ 'E1537: More targets than Tuple items',
...
func Test_tuple_scriptvar_type()
  ...
  let lines =<< trim END
    vim9script
    var foobar: tuple<string> = ('a', 'b')
    def Foo()
      var x = foobar
      assert_equal('tuple<string>', typename(x))
    enddef
    Foo()
  END
  call v9.CheckSourceScriptSuccess(lines)
...
func Test_tuple_modify()
  let lines =<< trim END
    ...
    t[0] = 3
  END
  call v9.CheckSourceDefAndScriptFailure(lines, ['E1531: Cannot modify a tuple', 'E1531: Cannot modify a tuple'])
endfunc
...
func Test_tuple_modify_mutable_item()
  ...
  END
  call v9.CheckLegacyAndVim9Failure(lines, [
        \ 'E1518: Tuple index out of range: 2',
        \ 'E1518: Tuple index out of range: 2',
        \ 'E1518: Tuple index out of range: 2'])
...
func Test_tuple_func_arg()
  let lines =<< trim END
    vim9script
    def Fn(t: tuple<string>): tuple<string>
      return t[:]
    enddef
    var r = Fn(('a', 'b'))
    assert_equal(('a', 'b'), r)
...
def Test_tuple_typecast()
  ...
  END
  v9.CheckSourceDefAndScriptFailure(lines, [
        \ 'E1012: Type mismatch; expected tuple<number> but got tuple<string>',
        \ 'E1012: Type mismatch; expected tuple<number> but got tuple<string>'])
enddef
...
def Test_tuple_string_interop()
  ...
  END
  v9.CheckLegacyAndVim9Success(lines)
...
func Test_tuple_slice_func()
  ...
  let lines =<< trim END
    var t: tuple<number> = (1, 3, 5)
    var x: tuple<number> = slice(t, 1, 2)
    assert_equal((3,), x)
  END
  call v9.CheckSourceDefAndScriptSuccess(lines)
endfunc
...
func Test_tuple_typename()
  let lines =<< trim END
    ...
    VAR t1 = (([1, 2],), (['a', 'b'],))
    call assert_equal('tuple<tuple<list<any>>>', typename(t1))
  ...
  let lines =<< trim END
    var t: tuple<number> =  (1, 2)
    var x: tuple<number> =  t
    assert_equal('tuple<number>', typename(x))
  END
  call v9.CheckSourceDefAndScriptSuccess(lines)
endfunc
...
func Test_list2tuple()
  ...
  let lines =<< trim END
    var l1 = [1, 2]
    var t1 = list2tuple(l1)
    assert_equal('tuple<number>', typename(t1))
    var l2 = ['a', 'b']
    var t2 = list2tuple(l2)
    assert_equal('tuple<string>', typename(t2))
    var l3 = []
    var t3 = list2tuple(l3)
    assert_equal('tuple<any>', typename(t3))
    var l4 = [([{}])]
    var t4 = list2tuple(l4)
...
func Test_tuple2list()
  ...
  call assert_fails('call tuple2list([])', 'E1533: Tuple required for argument 1')
