...
func Test_blob_encode()
  call assert_equal(0z616263E4.B896E795.8C, blob_encode(['abc世界']))
  call assert_equal(0z, blob_encode([]))
  call assert_equal(0z, blob_encode(['']))
  call assert_equal(0z00, blob_encode(['', '']))
  call assert_equal(0z30, blob_encode([0]))
  call assert_fails('call blob_encode(0)', 'E474:')
endfunc

func Test_blob_decode()
  call assert_equal(['abc世界'], blob_decode(0z616263E4.B896E795.8C))
  call assert_equal([''], blob_decode(0z))
  call assert_equal(['', ''], blob_decode(0z00))
  call assert_equal(['abc'], blob_decode(0z616263))
  call assert_equal(['', 'abc'], blob_decode(0z00616263))
  call assert_equal(['', '', 'abc'], blob_decode(0z0000616263))
  call assert_equal(['', '', 'abc', ''], blob_decode(0z000061626300))
  call assert_equal(['', '', 'abc', '', ''], blob_decode(0z00006162630000))
  call assert_fails('call blob_decode(0)', 'E474:')
endfunc
