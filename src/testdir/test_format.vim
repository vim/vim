...
func Test_printf_pos_errors()
  ...
  call v9.CheckLegacyAndVim9Failure(["call printf('%.1000000000000$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%.1000000000000d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000000000$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000000000d', 5)"], "E1510:")

  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$5.5d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$5000000.5d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$5.5000000d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$5000000.5d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$5000000.5000000d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$5.5000000d', 5)"], "E1510:")

  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$*1$.5d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$*1000000$.5d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$*1$.5000000d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$*1000000$.5d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$*1000000$.5000000d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$*1$.5000000d', 5)"], "E1510:")

  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$5.*1$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$5000000.*1$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$5.*1000000$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$5000000.*1$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$5000000.*1000000$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$5.*1000000$d', 5)"], "E1510:")

  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$*1$.*1$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$*1000000$.*1$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$*1$.*1000000$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$*1000000$.*1$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$*1000000$.*1000000$d', 5)"], "E1510:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1000000$*1$.*1000000$d', 5)"], "E1510:")
endfunc
