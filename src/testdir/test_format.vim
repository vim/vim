...
func Test_printf_pos_misc()
  let lines =<< trim END
      ...
      call assert_equal('1 at width 2 is: 01', printf("%1$d at width %2$d is: %1$0*2$d", 1, 2))
  ...
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$d at width %2$ld is: %1$0*2$d', 1, 2)"], "E1402:")
  ...
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$d at width %2$d is: %1$0*2$.*3$d', 3)"], "E1403:")
  call v9.CheckLegacyAndVim9Failure(["call printf('%1$d at width %2$d is: %1$0*2$.*3$d', 3, 2)"], "E1403:")
