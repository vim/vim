...
func Test_fnamemodify()
  ...
  call assert_equal('../../testdir/f', fnamemodify('~/testdir/f', ':,'))
  call assert_equal('../../testdir/f/g', fnamemodify('~/testdir/f/g', ':,'))
  call assert_equal('~/XXXXXXXX/a.ext', fnamemodify('~/XXXXXXXX/a.ext', ':,'))
  call chdir(cwd)
