...
def Test_get_generic_funcref_using_function()
  ...
  lines =<< trim END
    ...
    var Fx = function(Fn<)
  END
  v9.CheckSourceFailure(lines, 'E1010: Type not recognized:', 4)
...
def Test_generic_funcref_string()
  ...
  lines =<< trim END
    ...
    Fx<number, string>()
  END
  v9.CheckSourceFailure(lines, 'E1553: Too many types specified for generic function', 5)
  ...
  lines =<< trim END
    ...
    Fx<string>()
  END
  v9.CheckSourceFailure(lines, 'E1554: Not enough types specified for generic function', 5)
...
def Test_generic_obj_method_call_from_another_method()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1555: Unknown generic function: Fn', 2)
...
def Test_generic_class_method_call_from_another_method()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1555: Unknown generic function: Fn', 1)
enddef
