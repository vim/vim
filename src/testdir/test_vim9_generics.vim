...
def Test_generic_func_definition()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1549: Generic type name must start with an uppercase letter: t>()', 2)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1549: Generic type name must start with an uppercase letter: mytype>()', 2)
...
def Test_generic_nested_functions()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckScriptFailure(lines, 'E1549: Generic type name must start with an uppercase letter: a>()', 1)
