...
def Test_generic_func_definition()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1549: Type variable name must start with an uppercase letter: t>()', 2)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1549: Type variable name must start with an uppercase letter: mytype>()', 2)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1550: Missing comma after type in generic function: My-type>()', 2)
...
def Test_generic_func_invoke()
  ...
  lines =<< trim END
    ...
    Fn<
  END
  v9.CheckSourceFailure(lines, "E1551: Missing '>' in generic function: <", 4)
...
def Test_generic_funcref_string()
  ...
  lines =<< trim END
    ...
    var Fx = function('Fn<number')
  END
  v9.CheckSourceFailure(lines, "E1551: Missing '>' in generic function: <number", 4)
  ...
  lines =<< trim END
    ...
    Fx<>()
  END
  v9.CheckSourceFailure(lines, "E1552: Empty type list specified for generic function '<>()'", 5)
...
def Test_generic_funcref_string_from_another_function()
  ...
  lines =<< trim END
    ...
    Foo()
  END
  v9.CheckSourceFailure(lines, "E1551: Missing '>' in generic function: <", 1)
  ...
  lines =<< trim END
    ...
    Foo()
  END
  v9.CheckSourceFailure(lines, "E1551: Missing '>' in generic function: <number", 1)
...
def Test_generic_obj_method()
  ...
  lines =<< trim END
    ...
    a.Fn<>()
  END
  v9.CheckSourceFailureList(lines, ["E1552: Empty type list specified for generic function '<>()'"])
...
def Test_generic_obj_method_call_from_another_method()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckSourceFailure(lines, 'E1557: Not a generic function: Fn', 2)
...
def Test_generic_function_disassemble()
  ...
  END
  v9.CheckScriptFailure(lines, "E1551: Missing '>' in generic function: <number, dict<number>", 2)
  ...
  END
  v9.CheckScriptFailure(lines, "E1551: Missing '>' in generic function: <number,", 2)

  lines =<< trim END
    vim9script
    disassemble Fn<
  END
  v9.CheckScriptFailure(lines, "E1551: Missing '>' in generic function: <", 2)
...
def Test_generic_duplicate_names()
  var lines =<< trim END
    ...
    defcompile
  END
  v9.CheckScriptFailure(lines, 'E1558: Duplicate type variable name: A', 2)
...
def Test_generic_nested_functions()
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckScriptFailure(lines, 'E1552: Empty type list specified for generic function', 3)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckScriptFailure(lines, "E1550: Missing comma after type in generic function: <A()", 3)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckScriptFailure(lines, 'E1549: Type variable name must start with an uppercase letter: a>()', 1)
  ...
  lines =<< trim END
    ...
    defcompile
  END
  v9.CheckScriptFailure(lines, 'E1558: Duplicate type variable name: T', 1)
enddef
