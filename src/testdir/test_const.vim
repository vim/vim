...
func Test_const_with_index_access()
    let l = [1, 2, 3]
    call assert_fails('const l[0] = 4', 'E995:')
    call assert_fails('const l[0:1] = [1, 2]', 'E995:')

    let d = {'aaa': 0}
    call assert_fails("const d['aaa'] = 4", 'E995:')
    call assert_fails("const d.aaa = 4", 'E995:')
endfunc
...
func Test_const_with_special_variables()
    call assert_fails('const $FOO = "hello"', 'E995:')
    call assert_fails('const @a = "hello"', 'E995:')
    call assert_fails('const &filetype = "vim"', 'E995:')
    call assert_fails('const &l:filetype = "vim"', 'E995:')
    call assert_fails('const &g:encoding = "utf-8"', 'E995:')
endfunc
