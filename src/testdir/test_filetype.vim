...
let s:filename_checks = {
    ...
    \ 'gitsendemail': ['.gitsendemail.msg.xxxxxx', '.gitsendemail.msg.??????'],
    \ 'gkrellmrc': ['gkrellmrc', 'gkrellmrc_x', 'gkrellmrc_?'],
    ...
    \ 'jproperties': ['file.properties', 'file.properties_xx', 'file.properties_xx_xx', 'file.properties_??', 'file.properties_??_??', 'some.properties_??_??_', 'some.properties_??_??_-file'],
