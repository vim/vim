...
def s:GetFilenameChecks(): dict<list<string>>
  return {
    ...
    elsa: ['file.lc'],
    elvish: ['file.elv'],
    env: ['.env', '.envrc', '.env.file', '.envrc.file', 'file.env', 'file.envrc'],
    epuppet: ['file.epp'],
...
#    log: ['file.log', 'file_log', 'file.LOG', 'file_LOG'],
    ...
    sh: ['.bashrc', '.bash_profile', '.bash-profile', '.bash_logout', '.bash-logout', '.bash_aliases', '.bash-aliases', '.bash_history', '.bash-history',
         ...
         'user-dirs.defaults', 'user-dirs.dirs', 'makepkg.conf', '.makepkg.conf', 'file.mdd', 'file.cygport', 'devscripts.conf',
