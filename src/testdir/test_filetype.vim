...
def s:GetFilenameChecks(): dict<list<string>>
  return {
    ...
    dosini: ['/etc/yum.conf', '/etc/nfs.conf', '/etc/nfsmount.conf', 'file.ini',
             ...
             'any/etc/portage/repos.conf', 'any/etc/portage/repos.conf/file',
             'any/etc/portage/binrepos.conf', 'any/etc/portage/binrepos.conf/file',
             'any/usr/share/portage/config/repos.conf', 'any/usr/share/portage/config/set/file',
    ...
    sh: ['.bashrc', '.bash_profile', '.bash-profile', '.bash_logout', '.bash-logout', '.bash_aliases', '.bash-aliases', '.bash_history', '.bash-history',
         ...
         '.devscripts', 'file.lo', 'file.la', 'file.lai', 'any/etc/portage/make.conf', 'any/etc/portage/make.conf/file',
         'any/etc/portage/repo.postsync.d/file', 'any/etc/portage/color.map', 'any/usr/share/portage/config/make.conf.example',
         'any/usr/share/portage/config/make.global', 'any/usr/share/portage/config/repo.postsync.d/file'],
