...
func Test_find_complete()
  ...
  new
  set path=
  call assert_fails('call feedkeys(":find\<Tab>\<CR>", "xt")', 'E345:')
  close

  new
  set path=.
  call assert_fails('call feedkeys(":find\<Tab>\<CR>", "xt")', 'E32:')
  close
  ...
  new
  set path=Xfind/**
  call feedkeys(":find file\<Tab>\<CR>", "xt")
  call assert_equal('Holy Grail', getline(1))
  call feedkeys(":find file\<Tab>\<Tab>\<CR>", "xt")
  call assert_equal('Jimmy Hoffa', getline(1))
  call feedkeys(":find file\<Tab>\<Tab>\<Tab>\<CR>", "xt")
  ...
  set path=.
  call feedkeys(":find st\<Tab>\<CR>", "xt")
  ...
  cd Xfind
  set path=,,
  call feedkeys(":find f\<Tab>\<CR>", "xt")
  call assert_equal('Holy Grail', getline(1))
  ...
  exec "set path=" . cwd . "/Xfind/**"
  call feedkeys(":find voyager\<Tab>\<CR>", "xt")
  call assert_equal('Voyager 1', getline(1))
  call feedkeys(":find voyager\<Tab>\<Tab>\<CR>", "xt")
  ...
  call feedkeys(":find stu\<Tab>\<CR>", "xt")
  call assert_equal('Another Holy Grail', getline(1))
