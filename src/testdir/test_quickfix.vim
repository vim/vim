...
func Test_Autocmd()
  ...
  let g:acmds = []
  new! | call append(0, "F2:10:Line 10")
  cbuffer!
  new! | call append(0, "F2:20:Line 20")
  cgetbuffer
  new! | call append(0, "F2:30:Line 30")
  caddbuffer
  new
  let bnum = bufnr('%')
  bunload
