...
def Test_repeat()
  v9.CheckDefAndScriptFailure(['repeat(1.1, 2)'], ['E1013: Argument 1: type mismatch, expected string but got float', 'EXXXX: String, Number, List or Blob required for argument 1'])
  v9.CheckDefAndScriptFailure(['repeat({a: 10}, 2)'], ['E1013: Argument 1: type mismatch, expected string but got dict<', 'EXXXX: String, Number, List or Blob required for argument 1'])
  var lines =<< trim END
