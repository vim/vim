...
func Test_search_stat()
  ...
  call assert_equal(#{current: 1, total: 40, timeout: 0}, searchcount(#{pattern: 'foo'}))
  ...
  call assert_equal(#{current: 2, total: 50, timeout: 0}, searchcount(#{recompute: 0}))
  ...
  let stat = '\[50/50\]'
  call assert_match(pat .. stat, g:a)
  call assert_equal(#{current: 50, total: 50, timeout: 0}, searchcount(#{recompute: 0}))
  ...
  call assert_equal(#{current: 50, total: 50, timeout: 0}, searchcount(#{recompute: 0}))
  call assert_equal(#{current: 2, total: 50, timeout: 0}, searchcount(#{recompute: v:true}))
  set shortmess-=S
  ...
  let stat = '\[>99/>99\]'
  call assert_match(pat .. stat, g:a)
  call assert_equal(#{current: 101, total: 100, timeout: 0}, searchcount(#{recompute: 0}))
  ...
  let stat = 'W \[1/>99\]'
  call assert_match(pat .. stat, g:a)
  call assert_equal(#{current: 1, total: 100, timeout: 0}, searchcount(#{recompute: 0}))
