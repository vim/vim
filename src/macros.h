...
#define DICTITEM_ALLOC_KEYLITERAL(key) dictitem_alloc((char_u *)(key), STRLEN_LITERAL(key))
#define DICT_ADD_STRING_KEYLITERAL(dict, key, str) dict_add_string((dict), (char_u *)(key), STRLEN_LITERAL(key), (str))
#define DICT_ADD_STRING_LEN_KEYLITERAL(dict, key, str, len) dict_add_string_len((dict), (char_u *)(key), STRLEN_LITERAL(key), (str), (len))
#define DICT_ADD_NUMBER_KEYLITERAL(dict, key, nr) dict_add_number((dict), (char_u *)(key), STRLEN_LITERAL(key), (nr))
#define DICT_ADD_BOOL_KEYLITERAL(dict, key, nr) dict_add_bool((dict), (char_u *)(key), STRLEN_LITERAL(key), (nr))
#define DICT_ADD_LIST_KEYLITERAL(dict, key, list) dict_add_list((dict), (char_u *)(key), STRLEN_LITERAL(key), (list))
#define DICT_ADD_TV_KEYLITERAL(dict, key, tv) dict_add_tv((dict), (char_u *)(key), STRLEN_LITERAL(key), (tv))
#define DICT_ADD_CALLBACK_KEYLITERAL(dict, key, cb) dict_add_callback((dict), (char_u *)(key), STRLEN_LITERAL(key), (cb))
#define DICT_ADD_FUNC_KEYLITERAL(dict, key, func) dict_add_func((dict), (char_u *)(key), STRLEN_LITERAL(key), (func))
#define DICT_ADD_DICT_KEYLITERAL(dest_dict, key, src_dict) dict_add_dict((dest_dict), (char_u *)(key), STRLEN_LITERAL(key), (src_dict))
