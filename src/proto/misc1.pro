...
hash_T conceal_vts_hash(win_T *wp);
int conceal_rightleft(win_T *wp);
int conceal_ambiwidth(void);
hash_T conceal_width_state_hash(void);
hash_T conceal_syntax_state_hash(win_T *wp);
hash_T conceal_wcol_state_hash(win_T *wp);
bool plines_win_may_conceal(win_T *wp, linenr_T lnum);
bool conceal_match_may_conceal(win_T *wp);
bool conceal_layout_may_change(win_T *wp);
bool conceal_has_dynamic_pattern(win_T *wp);
