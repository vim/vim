...
void old_prepend_joined_props(buf_T *buf, char_u *new_props, int propcount, int *props_remaining, linenr_T lnum, int first_line, int last_line, long col, int removed);
...
void prop_trim_leading_bytes( buf_T *buf, linenr_T lnum, colnr_T count, int *flags);
