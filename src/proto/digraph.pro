...
void digraph_get_list_common(int list_all, typval_T *rettv);
void f_digraph_get(typval_T *argvars, typval_T *rettv);
void f_digraph_get_list(typval_T *argvars, typval_T *rettv);
void f_digraph_set(typval_T *argvars, typval_T *rettv);
void f_digraph_set_list(typval_T *argvars, typval_T *rettv);
