...
int sign_place(int id, char_u *sign_name, buf_T *buf, linenr_T lnum);
int sign_unplace(int id, buf_T *buf);
void sign_get_placed(buf_T *buf, linenr_T lnum, int id, list_T *retlist);
/* vim: set ft=c : */
