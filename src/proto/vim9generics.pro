...
char_u *parse_generic_type_args(char_u *name, size_t namelen, char_u *start, gfargs_tab_T *gfatab, cctx_T *cctx);
char_u *parse_generic_type_params(char_u *name, char_u *p, gfargs_tab_T *gfatab, cctx_T *cctx);
void generic_func_init(ufunc_T *fp, gfargs_tab_T *gfatab);
void generic_args_table_init(gfargs_tab_T *gfatab);
int generic_args_table_size(gfargs_tab_T *gfatab);
void generic_args_table_clear(gfargs_tab_T *gfatab);
