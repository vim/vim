...
char_u *parse_generic_func_type_args(char_u *func_name, size_t namelen, char_u *start, garray_T *types_gap, garray_T *gftn_gap, cctx_T *cctx);
char_u *parse_generic_func_type_params(char_u *func_name, char_u *p, garray_T *gtl_gap, garray_T *gt_gap, cctx_T *cctx);
void generic_func_init(ufunc_T *fp, garray_T *gtl_gap, garray_T *gt_gap);
