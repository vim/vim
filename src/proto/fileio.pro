...
size_t msg_add_fname(char_u *dst, size_t dstsize, buf_T *buf, char_u *fname);
size_t msg_add_fileformat(char_u *dst, size_t dstsize, int eol_type);
size_t msg_add_lines(char_u *dst, size_t dstsize, int insert_space, long lnum, off_T nchars);
size_t msg_add_eol(char_u *dst, size_t dstsize);
