...
void search_stat(int dirc, pos_T *pos, char_u *msgbuf, int recompute, int max);
...
int has_last_search_stat();
void set_last_search_stat(dict_T *dict);
void get_last_search_stat(dict_T *dict);
