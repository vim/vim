...
bool tsobject_is_query(tsobject_T *obj);
bool tsobject_is_querycursor(tsobject_T *obj);
bool tsobject_is_querymatch(tsobject_T *obj);
...
tsobject_T *tstree_root_node(tsobject_T *tree);
dict_T *tsnode_info(tsobject_T *node);
tsobject_T *tsquery_new(char_u *language, char_u *query_str);
/* vim: set ft=c : */
