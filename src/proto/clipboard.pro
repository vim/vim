...
void clip_x11_update_formats(Widget myShell, Display *dpy, Clipboard_T *cbd);
int clip_x11_request_format(Widget myShell, Display *dpy, Clipboard_T *cbd, char_u *format, garray_T *ga);
...
void clip_update_supported_formats(Clipboard_T *cbd);
