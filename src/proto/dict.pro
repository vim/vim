...
dictitem_T *dictitem_alloc(char_u *key, size_t keylen);
...
int dict_add_number(dict_T *d, char_u *key, size_t keylen, varnumber_T nr);
int dict_add_bool(dict_T *d, char_u *key, size_t keylen, varnumber_T nr);
int dict_add_string(dict_T *d, char_u *key, size_t keylen, char_u *str);
int dict_add_string_len(dict_T *d, char_u *key, size_t keylen, char_u *str, int len);
int dict_add_list(dict_T *d, char_u *key, size_t keylen, list_T *list);
int dict_add_tv(dict_T *d, char_u *key, size_t keylen, typval_T *tv);
int dict_add_callback(dict_T *d, char_u *key, size_t keylen, callback_T *cb);
int dict_add_func(dict_T *d, char_u *key, size_t keylen, ufunc_T *fp);
...
int dict_add_dict(dict_T *d, char_u *key, size_t keylen, dict_T *dict);
