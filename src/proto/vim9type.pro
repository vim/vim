...
bool type_contains_union(type_T *type);
...
bool construct_union_type(type_T **first, type_T *init_value, type_T **cur, type_T *type, garray_T *type_gap);
void check_union_type(type_T *type);
