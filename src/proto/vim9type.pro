...
void set_type_resolve_ctx_ufunc(ufunc_T *fp);
ufunc_T *get_type_resolve_ctx_ufunc(void);
void set_type_resolve_ctx_class(class_T *cl);
class_T *get_type_resolve_ctx_class(void);
void clear_type_resolve_ctx(void);
...
type_T *parse_type(char_u **arg, garray_T *type_gap, cctx_T *cctx, int give_error);
