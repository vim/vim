...
char_u *generic_func_get_types(char_u *start, garray_T *types_gap, garray_T *gtfn_gap);
...
int call_func(char_u *funcname, int len, typval_T *rettv, int argcount_in, typval_T *argvars_in, garray_T *gt_gap, funcexe_T *funcexe);
