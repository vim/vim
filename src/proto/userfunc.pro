...
ufunc_T *define_function(exarg_T *eap, char_u *name_arg, garray_T *lines_to_free, class_T *cl, int class_flags, ocmember_T *obj_members, int obj_member_count, cctx_T *cctx);
