...
char_u *getcmdline(int firstc, long count, int indent, int dont_concat);
...
char_u *getexline(int c, void *cookie, int indent, int dont_concat);
char_u *getexmodeline(int promptc, void *cookie, int indent, int dont_concat);
