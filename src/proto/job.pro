...
void init_prompt_history(buf_T *buf, bool clear);
bool goto_prompt_history(buf_T *buf, int offset, bool relative);
...
void f_prompt_sethistsize(typval_T *argvars, typval_T *rettv);
void f_prompt_gethistory(typval_T *argvars, typval_T *rettv);
void f_prompt_sethistory(typval_T *argvars, typval_T *rettv);
void f_prompt_histgoto(typval_T *argvars, typval_T *rettv);
void f_prompt_histsearch(typval_T *argvars, typval_T *rettv);
