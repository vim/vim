...
int oneright(void);
int oneleft(void);
linenr_T cursor_up(win_T *wp, long n, int upd_topline);
linenr_T cursor_up_adv(win_T *wp, long n, int upd_topline);
linenr_T cursor_down(win_T *wp, long n, int upd_topline);
linenr_T cursor_down_adv(win_T *wp, long n, int upd_topline);
