...
int emsg(char *s) ATTRIBUTE_COLD;
void iemsg(char *s) ATTRIBUTE_COLD;
void internal_error(char *where) ATTRIBUTE_COLD;
void internal_error_no_abort(char *where) ATTRIBUTE_COLD;
void emsg_invreg(int name) ATTRIBUTE_COLD;
void emsg_namelen(char *msg, char_u *name, int len) ATTRIBUTE_COLD;
