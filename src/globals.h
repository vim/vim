...
#endif
EXTERN guicolor_T fallback_fg_rgb INIT(= INVALCOLOR); // RGB fallback foreground color from guifg, ctermrg or deduced form background
EXTERN guicolor_T fallback_bg_rgb INIT(= INVALCOLOR); // RGB fallback bakcground color from guibg, ctermbg or deduced form background
