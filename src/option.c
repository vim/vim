...
/*
 * Set the callback function value for an option that accepts functions.
 * (e.g. 'operatorfunc', 'tagfunc', etc.)
 * Returns TRUE if the option is successfully set to a function, otherwise
 * returns FALSE.
 */
    int
