...
#ifdef USE_GTK3
# define GTK_FORM(obj) \
     (G_TYPE_CHECK_INSTANCE_CAST((obj), GTK_TYPE_FORM, GtkForm))
# define GTK_FORM_CLASS(klass) \
     (G_TYPE_CHECK_CLASS_CAST((klass), GTK_TYPE_FORM, GtkFormClass))
# define GTK_IS_FORM(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_FORM))
# define GTK_IS_FORM_CLASS(klass) \
     (G_TYPE_CHECK_CLASS_TYPE((klass), GTK_TYPE_FORM))
#else
# define GTK_FORM(obj) (GTK_CHECK_CAST((obj), GTK_TYPE_FORM, GtkForm))
# define GTK_FORM_CLASS(klass) \
     (GTK_CHECK_CLASS_CAST((klass), GTK_TYPE_FORM, GtkFormClass))
...
void gui_gtk_form_move_resize(GtkForm *form,
                              GtkWidget *widget,
                              gint x,
                              gint y,
                              gint w,
