...
SRC =	arabic.c arglist.c autocmd.c beval.c blob.c blowfish.c buffer.c \
	bufwrite.c change.c charset.c cmdexpand.c cmdhist.c crypt.c \
	crypt_zip.c debugger.c dict.c diff.c digraph.c drawline.c drawscreen.c \
	...
	if_xcmdsrv.c fileio.c filepath.c, findfile.c fold.c getchar.c \
	...
	popupmenu.c popupwin.c profiler.c quickfix.c regexp.c register.c \
	scriptfile.c search.c session.c sha256.c sign.c spell.c spellfile.c \
	spellsuggest.c syntax.c tag.c term.c termlib.c testing.c textprop.c \
	ui.c undo.c usercmd.c userfunc.c version.c viminfo.c screen.c \
	window.c os_unix.c os_vms.c pathdef.c \
	$(GUI_SRC) $(PERL_SRC) $(PYTHON_SRC) $(TCL_SRC) \
 	$(RUBY_SRC) $(HANGULIN_SRC) $(MZSCH_SRC) $(XDIFF_SRC)

OBJ = 	arabic.obj arglist.obj autocmd.obj beval.obj blob.obj blowfish.obj \
	buffer.obj bufwrite.obj change.obj charset.obj cmdexpand.obj \
	cmdhist.obj crypt.obj crypt_zip.obj debugger.obj dict.obj diff.obj \
	digraph.obj drawline.obj drawscreen.obj edit.obj eval.obj \
	evalbuffer.obj evalfunc.obj evalvars.obj evalwindow.obj ex_cmds.obj \
	ex_cmds2.obj ex_docmd.obj ex_eval.obj ex_getln.obj if_cscope.obj \
	if_xcmdsrv.obj fileio.obj filepath.obj findfile.obj fold.obj \
	getchar.obj hardcopy.obj hashtab.obj highlight.obj indent.obj \
	insexpand.obj json.obj list.obj main.obj map.obj mark.obj menu.obj \
	memfile.obj memline.obj message.obj misc1.obj misc2.obj mouse.obj \
	move.obj mbyte.obj normal.obj ops.obj option.obj optionstr.obj \
	popupmenu.obj popupwin.obj profiler.obj quickfix.obj regexp.obj \
	register.obj scriptfile.obj search.obj session.obj sha256.obj sign.obj \
	spell.obj spellfile.obj spellsuggest.obj syntax.obj tag.obj term.obj \
	termlib.obj testing.obj textprop.obj ui.obj undo.obj usercmd.obj \
	userfunc.obj screen.obj version.obj viminfo.obj window.obj os_unix.obj \
