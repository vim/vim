...
restore_visual_mode(void)
{
    ...
    int
get_resel_visual_mode(void)
{
    return resel_VIsual_mode;
}

    void
set_resel_visual_mode(int mode)
{
    resel_VIsual_mode = mode;
}

    linenr_T
get_resel_visual_line_count(void)
{
    return resel_VIsual_line_count;
}

    void
set_resel_visual_line_count(linenr_T line_count)
{
    resel_VIsual_line_count = line_count;
}

    colnr_T
get_resel_visual_vcol(void)
{
    return resel_VIsual_vcol;
}

    void
set_resel_visual_vcol(colnr_T col)
{
    resel_VIsual_vcol = col;
}
