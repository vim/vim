...
static char *(p_wop_values[]) = {"fuzzy", "tagfile", "pum", "reverse", NULL};
#ifdef FEAT_WAK
...
#endif
static char *(p_cot_values[]) = {"menu", "menuone", "longest", "preview", "popup", "popuphidden", "noinsert", "noselect", "fuzzy", "reverse", NULL};
