...
EXTERN char e_tuple_is_immutable[]
	INIT(= N_("E1531: Cannot modify a tuple"));
EXTERN char e_cannot_slice_tuple[]
	INIT(= N_("E1532: Cannot slice a tuple"));
EXTERN char e_tuple_required_for_argument_nr[]
	INIT(= N_("E1533: Tuple required for argument %d"));
EXTERN char e_list_or_tuple_required[]
	INIT(= N_("E1534: List or Tuple required"));
EXTERN char e_tuple_required[]
	INIT(= N_("E1535: Tuple required"));
EXTERN char e_less_targets_than_tuple_items[]
	INIT(= N_("E1536: Less targets than Tuple items"));
EXTERN char e_more_targets_than_tuple_items[]
	INIT(= N_("E1537: More targets than Tuple items"));
#endif
