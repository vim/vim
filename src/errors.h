...
EXTERN char e_digraph_set_list_argument_must_be_list_of_lists_with_two_items[]
	INIT(= N_("E1216: digraph_set_list() argument must be a list of lists with two items"));
#endif
